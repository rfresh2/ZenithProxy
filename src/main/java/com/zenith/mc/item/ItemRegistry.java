...
public final class ItemRegistry {
    public static final Registry<ItemData> REGISTRY = new Registry<ItemData>(1506);
    ...
    static {
        ...
        GOLDEN_DANDELION = REGISTRY.register(data.get(230));
        OPEN_EYEBLOSSOM = REGISTRY.register(data.get(231));
        CLOSED_EYEBLOSSOM = REGISTRY.register(data.get(232));
        POPPY = REGISTRY.register(data.get(233));
        BLUE_ORCHID = REGISTRY.register(data.get(234));
        ALLIUM = REGISTRY.register(data.get(235));
        AZURE_BLUET = REGISTRY.register(data.get(236));
        RED_TULIP = REGISTRY.register(data.get(237));
        ORANGE_TULIP = REGISTRY.register(data.get(238));
        WHITE_TULIP = REGISTRY.register(data.get(239));
        PINK_TULIP = REGISTRY.register(data.get(240));
        OXEYE_DAISY = REGISTRY.register(data.get(241));
        CORNFLOWER = REGISTRY.register(data.get(242));
        LILY_OF_THE_VALLEY = REGISTRY.register(data.get(243));
        WITHER_ROSE = REGISTRY.register(data.get(244));
        TORCHFLOWER = REGISTRY.register(data.get(245));
        PITCHER_PLANT = REGISTRY.register(data.get(246));
        SPORE_BLOSSOM = REGISTRY.register(data.get(247));
        BROWN_MUSHROOM = REGISTRY.register(data.get(248));
        RED_MUSHROOM = REGISTRY.register(data.get(249));
        CRIMSON_FUNGUS = REGISTRY.register(data.get(250));
        WARPED_FUNGUS = REGISTRY.register(data.get(251));
        CRIMSON_ROOTS = REGISTRY.register(data.get(252));
        WARPED_ROOTS = REGISTRY.register(data.get(253));
        NETHER_SPROUTS = REGISTRY.register(data.get(254));
        WEEPING_VINES = REGISTRY.register(data.get(255));
        TWISTING_VINES = REGISTRY.register(data.get(256));
        SUGAR_CANE = REGISTRY.register(data.get(257));
        KELP = REGISTRY.register(data.get(258));
        PINK_PETALS = REGISTRY.register(data.get(259));
        WILDFLOWERS = REGISTRY.register(data.get(260));
        LEAF_LITTER = REGISTRY.register(data.get(261));
        MOSS_CARPET = REGISTRY.register(data.get(262));
        MOSS_BLOCK = REGISTRY.register(data.get(263));
        PALE_MOSS_CARPET = REGISTRY.register(data.get(264));
        PALE_HANGING_MOSS = REGISTRY.register(data.get(265));
        PALE_MOSS_BLOCK = REGISTRY.register(data.get(266));
        HANGING_ROOTS = REGISTRY.register(data.get(267));
        BIG_DRIPLEAF = REGISTRY.register(data.get(268));
        SMALL_DRIPLEAF = REGISTRY.register(data.get(269));
        BAMBOO = REGISTRY.register(data.get(270));
        OAK_SLAB = REGISTRY.register(data.get(271));
        SPRUCE_SLAB = REGISTRY.register(data.get(272));
        BIRCH_SLAB = REGISTRY.register(data.get(273));
        JUNGLE_SLAB = REGISTRY.register(data.get(274));
        ACACIA_SLAB = REGISTRY.register(data.get(275));
        CHERRY_SLAB = REGISTRY.register(data.get(276));
        DARK_OAK_SLAB = REGISTRY.register(data.get(277));
        PALE_OAK_SLAB = REGISTRY.register(data.get(278));
        MANGROVE_SLAB = REGISTRY.register(data.get(279));
        BAMBOO_SLAB = REGISTRY.register(data.get(280));
        BAMBOO_MOSAIC_SLAB = REGISTRY.register(data.get(281));
        CRIMSON_SLAB = REGISTRY.register(data.get(282));
        WARPED_SLAB = REGISTRY.register(data.get(283));
        STONE_SLAB = REGISTRY.register(data.get(284));
        SMOOTH_STONE_SLAB = REGISTRY.register(data.get(285));
        SANDSTONE_SLAB = REGISTRY.register(data.get(286));
        CUT_SANDSTONE_SLAB = REGISTRY.register(data.get(287));
        PETRIFIED_OAK_SLAB = REGISTRY.register(data.get(288));
        COBBLESTONE_SLAB = REGISTRY.register(data.get(289));
        BRICK_SLAB = REGISTRY.register(data.get(290));
        STONE_BRICK_SLAB = REGISTRY.register(data.get(291));
        MUD_BRICK_SLAB = REGISTRY.register(data.get(292));
        NETHER_BRICK_SLAB = REGISTRY.register(data.get(293));
        QUARTZ_SLAB = REGISTRY.register(data.get(294));
        RED_SANDSTONE_SLAB = REGISTRY.register(data.get(295));
        CUT_RED_SANDSTONE_SLAB = REGISTRY.register(data.get(296));
        PURPUR_SLAB = REGISTRY.register(data.get(297));
        PRISMARINE_SLAB = REGISTRY.register(data.get(298));
        PRISMARINE_BRICK_SLAB = REGISTRY.register(data.get(299));
        DARK_PRISMARINE_SLAB = REGISTRY.register(data.get(300));
        SMOOTH_QUARTZ = REGISTRY.register(data.get(301));
        SMOOTH_RED_SANDSTONE = REGISTRY.register(data.get(302));
        SMOOTH_SANDSTONE = REGISTRY.register(data.get(303));
        SMOOTH_STONE = REGISTRY.register(data.get(304));
        BRICKS = REGISTRY.register(data.get(305));
        ACACIA_SHELF = REGISTRY.register(data.get(306));
        BAMBOO_SHELF = REGISTRY.register(data.get(307));
        BIRCH_SHELF = REGISTRY.register(data.get(308));
        CHERRY_SHELF = REGISTRY.register(data.get(309));
        CRIMSON_SHELF = REGISTRY.register(data.get(310));
        DARK_OAK_SHELF = REGISTRY.register(data.get(311));
        JUNGLE_SHELF = REGISTRY.register(data.get(312));
        MANGROVE_SHELF = REGISTRY.register(data.get(313));
        OAK_SHELF = REGISTRY.register(data.get(314));
        PALE_OAK_SHELF = REGISTRY.register(data.get(315));
        SPRUCE_SHELF = REGISTRY.register(data.get(316));
        WARPED_SHELF = REGISTRY.register(data.get(317));
        BOOKSHELF = REGISTRY.register(data.get(318));
        CHISELED_BOOKSHELF = REGISTRY.register(data.get(319));
        DECORATED_POT = REGISTRY.register(data.get(320));
        MOSSY_COBBLESTONE = REGISTRY.register(data.get(321));
        OBSIDIAN = REGISTRY.register(data.get(322));
        TORCH = REGISTRY.register(data.get(323));
        END_ROD = REGISTRY.register(data.get(324));
        CHORUS_PLANT = REGISTRY.register(data.get(325));
        CHORUS_FLOWER = REGISTRY.register(data.get(326));
        PURPUR_BLOCK = REGISTRY.register(data.get(327));
        PURPUR_PILLAR = REGISTRY.register(data.get(328));
        PURPUR_STAIRS = REGISTRY.register(data.get(329));
        SPAWNER = REGISTRY.register(data.get(330));
        CREAKING_HEART = REGISTRY.register(data.get(331));
        CHEST = REGISTRY.register(data.get(332));
        CRAFTING_TABLE = REGISTRY.register(data.get(333));
        FARMLAND = REGISTRY.register(data.get(334));
        FURNACE = REGISTRY.register(data.get(335));
        LADDER = REGISTRY.register(data.get(336));
        COBBLESTONE_STAIRS = REGISTRY.register(data.get(337));
        SNOW = REGISTRY.register(data.get(338));
        ICE = REGISTRY.register(data.get(339));
        SNOW_BLOCK = REGISTRY.register(data.get(340));
        CACTUS = REGISTRY.register(data.get(341));
        CACTUS_FLOWER = REGISTRY.register(data.get(342));
        CLAY = REGISTRY.register(data.get(343));
        JUKEBOX = REGISTRY.register(data.get(344));
        OAK_FENCE = REGISTRY.register(data.get(345));
        SPRUCE_FENCE = REGISTRY.register(data.get(346));
        BIRCH_FENCE = REGISTRY.register(data.get(347));
        JUNGLE_FENCE = REGISTRY.register(data.get(348));
        ACACIA_FENCE = REGISTRY.register(data.get(349));
        CHERRY_FENCE = REGISTRY.register(data.get(350));
        DARK_OAK_FENCE = REGISTRY.register(data.get(351));
        PALE_OAK_FENCE = REGISTRY.register(data.get(352));
        MANGROVE_FENCE = REGISTRY.register(data.get(353));
        BAMBOO_FENCE = REGISTRY.register(data.get(354));
        CRIMSON_FENCE = REGISTRY.register(data.get(355));
        WARPED_FENCE = REGISTRY.register(data.get(356));
        PUMPKIN = REGISTRY.register(data.get(357));
        CARVED_PUMPKIN = REGISTRY.register(data.get(358));
        JACK_O_LANTERN = REGISTRY.register(data.get(359));
        NETHERRACK = REGISTRY.register(data.get(360));
        SOUL_SAND = REGISTRY.register(data.get(361));
        SOUL_SOIL = REGISTRY.register(data.get(362));
        BASALT = REGISTRY.register(data.get(363));
        POLISHED_BASALT = REGISTRY.register(data.get(364));
        SMOOTH_BASALT = REGISTRY.register(data.get(365));
        SOUL_TORCH = REGISTRY.register(data.get(366));
        COPPER_TORCH = REGISTRY.register(data.get(367));
        GLOWSTONE = REGISTRY.register(data.get(368));
        INFESTED_STONE = REGISTRY.register(data.get(369));
        INFESTED_COBBLESTONE = REGISTRY.register(data.get(370));
        INFESTED_STONE_BRICKS = REGISTRY.register(data.get(371));
        INFESTED_MOSSY_STONE_BRICKS = REGISTRY.register(data.get(372));
        INFESTED_CRACKED_STONE_BRICKS = REGISTRY.register(data.get(373));
        INFESTED_CHISELED_STONE_BRICKS = REGISTRY.register(data.get(374));
        INFESTED_DEEPSLATE = REGISTRY.register(data.get(375));
        ...
        DEEPSLATE_BRICKS = REGISTRY.register(data.get(382));
        CRACKED_DEEPSLATE_BRICKS = REGISTRY.register(data.get(383));
        DEEPSLATE_TILES = REGISTRY.register(data.get(384));
        CRACKED_DEEPSLATE_TILES = REGISTRY.register(data.get(385));
        CHISELED_DEEPSLATE = REGISTRY.register(data.get(386));
        REINFORCED_DEEPSLATE = REGISTRY.register(data.get(387));
        ...
        MELON = REGISTRY.register(data.get(410));
        VINE = REGISTRY.register(data.get(411));
        GLOW_LICHEN = REGISTRY.register(data.get(412));
        RESIN_CLUMP = REGISTRY.register(data.get(413));
        RESIN_BLOCK = REGISTRY.register(data.get(414));
        RESIN_BRICKS = REGISTRY.register(data.get(415));
        RESIN_BRICK_STAIRS = REGISTRY.register(data.get(416));
        RESIN_BRICK_SLAB = REGISTRY.register(data.get(417));
        RESIN_BRICK_WALL = REGISTRY.register(data.get(418));
        CHISELED_RESIN_BRICKS = REGISTRY.register(data.get(419));
        ...
        NETHER_BRICKS = REGISTRY.register(data.get(425));
        CRACKED_NETHER_BRICKS = REGISTRY.register(data.get(426));
        CHISELED_NETHER_BRICKS = REGISTRY.register(data.get(427));
        NETHER_BRICK_FENCE = REGISTRY.register(data.get(428));
        NETHER_BRICK_STAIRS = REGISTRY.register(data.get(429));
        SCULK = REGISTRY.register(data.get(430));
        SCULK_VEIN = REGISTRY.register(data.get(431));
        SCULK_CATALYST = REGISTRY.register(data.get(432));
        SCULK_SHRIEKER = REGISTRY.register(data.get(433));
        ENCHANTING_TABLE = REGISTRY.register(data.get(434));
        END_PORTAL_FRAME = REGISTRY.register(data.get(435));
        END_STONE = REGISTRY.register(data.get(436));
        END_STONE_BRICKS = REGISTRY.register(data.get(437));
        DRAGON_EGG = REGISTRY.register(data.get(438));
        SANDSTONE_STAIRS = REGISTRY.register(data.get(439));
        ENDER_CHEST = REGISTRY.register(data.get(440));
        EMERALD_BLOCK = REGISTRY.register(data.get(441));
        OAK_STAIRS = REGISTRY.register(data.get(442));
        SPRUCE_STAIRS = REGISTRY.register(data.get(443));
        BIRCH_STAIRS = REGISTRY.register(data.get(444));
        JUNGLE_STAIRS = REGISTRY.register(data.get(445));
        ACACIA_STAIRS = REGISTRY.register(data.get(446));
        CHERRY_STAIRS = REGISTRY.register(data.get(447));
        DARK_OAK_STAIRS = REGISTRY.register(data.get(448));
        PALE_OAK_STAIRS = REGISTRY.register(data.get(449));
        MANGROVE_STAIRS = REGISTRY.register(data.get(450));
        BAMBOO_STAIRS = REGISTRY.register(data.get(451));
        BAMBOO_MOSAIC_STAIRS = REGISTRY.register(data.get(452));
        CRIMSON_STAIRS = REGISTRY.register(data.get(453));
        WARPED_STAIRS = REGISTRY.register(data.get(454));
        COMMAND_BLOCK = REGISTRY.register(data.get(455));
        BEACON = REGISTRY.register(data.get(456));
        COBBLESTONE_WALL = REGISTRY.register(data.get(457));
        MOSSY_COBBLESTONE_WALL = REGISTRY.register(data.get(458));
        BRICK_WALL = REGISTRY.register(data.get(459));
        PRISMARINE_WALL = REGISTRY.register(data.get(460));
        RED_SANDSTONE_WALL = REGISTRY.register(data.get(461));
        MOSSY_STONE_BRICK_WALL = REGISTRY.register(data.get(462));
        GRANITE_WALL = REGISTRY.register(data.get(463));
        STONE_BRICK_WALL = REGISTRY.register(data.get(464));
        MUD_BRICK_WALL = REGISTRY.register(data.get(465));
        NETHER_BRICK_WALL = REGISTRY.register(data.get(466));
        ANDESITE_WALL = REGISTRY.register(data.get(467));
        RED_NETHER_BRICK_WALL = REGISTRY.register(data.get(468));
        SANDSTONE_WALL = REGISTRY.register(data.get(469));
        END_STONE_BRICK_WALL = REGISTRY.register(data.get(470));
        DIORITE_WALL = REGISTRY.register(data.get(471));
        BLACKSTONE_WALL = REGISTRY.register(data.get(472));
        POLISHED_BLACKSTONE_WALL = REGISTRY.register(data.get(473));
        POLISHED_BLACKSTONE_BRICK_WALL = REGISTRY.register(data.get(474));
        COBBLED_DEEPSLATE_WALL = REGISTRY.register(data.get(475));
        POLISHED_DEEPSLATE_WALL = REGISTRY.register(data.get(476));
        DEEPSLATE_BRICK_WALL = REGISTRY.register(data.get(477));
        DEEPSLATE_TILE_WALL = REGISTRY.register(data.get(478));
        ANVIL = REGISTRY.register(data.get(479));
        CHIPPED_ANVIL = REGISTRY.register(data.get(480));
        DAMAGED_ANVIL = REGISTRY.register(data.get(481));
        CHISELED_QUARTZ_BLOCK = REGISTRY.register(data.get(482));
        QUARTZ_BLOCK = REGISTRY.register(data.get(483));
        QUARTZ_BRICKS = REGISTRY.register(data.get(484));
        QUARTZ_PILLAR = REGISTRY.register(data.get(485));
        QUARTZ_STAIRS = REGISTRY.register(data.get(486));
        WHITE_TERRACOTTA = REGISTRY.register(data.get(487));
        ORANGE_TERRACOTTA = REGISTRY.register(data.get(488));
        MAGENTA_TERRACOTTA = REGISTRY.register(data.get(489));
        LIGHT_BLUE_TERRACOTTA = REGISTRY.register(data.get(490));
        YELLOW_TERRACOTTA = REGISTRY.register(data.get(491));
        LIME_TERRACOTTA = REGISTRY.register(data.get(492));
        PINK_TERRACOTTA = REGISTRY.register(data.get(493));
        GRAY_TERRACOTTA = REGISTRY.register(data.get(494));
        LIGHT_GRAY_TERRACOTTA = REGISTRY.register(data.get(495));
        CYAN_TERRACOTTA = REGISTRY.register(data.get(496));
        PURPLE_TERRACOTTA = REGISTRY.register(data.get(497));
        BLUE_TERRACOTTA = REGISTRY.register(data.get(498));
        BROWN_TERRACOTTA = REGISTRY.register(data.get(499));
        GREEN_TERRACOTTA = REGISTRY.register(data.get(500));
        RED_TERRACOTTA = REGISTRY.register(data.get(501));
        BLACK_TERRACOTTA = REGISTRY.register(data.get(502));
        BARRIER = REGISTRY.register(data.get(503));
        LIGHT = REGISTRY.register(data.get(504));
        HAY_BLOCK = REGISTRY.register(data.get(505));
        WHITE_CARPET = REGISTRY.register(data.get(506));
        ORANGE_CARPET = REGISTRY.register(data.get(507));
        MAGENTA_CARPET = REGISTRY.register(data.get(508));
        LIGHT_BLUE_CARPET = REGISTRY.register(data.get(509));
        YELLOW_CARPET = REGISTRY.register(data.get(510));
        LIME_CARPET = REGISTRY.register(data.get(511));
        PINK_CARPET = REGISTRY.register(data.get(512));
        GRAY_CARPET = REGISTRY.register(data.get(513));
        LIGHT_GRAY_CARPET = REGISTRY.register(data.get(514));
        CYAN_CARPET = REGISTRY.register(data.get(515));
        PURPLE_CARPET = REGISTRY.register(data.get(516));
        BLUE_CARPET = REGISTRY.register(data.get(517));
        BROWN_CARPET = REGISTRY.register(data.get(518));
        GREEN_CARPET = REGISTRY.register(data.get(519));
        RED_CARPET = REGISTRY.register(data.get(520));
        BLACK_CARPET = REGISTRY.register(data.get(521));
        TERRACOTTA = REGISTRY.register(data.get(522));
        PACKED_ICE = REGISTRY.register(data.get(523));
        DIRT_PATH = REGISTRY.register(data.get(524));
        SUNFLOWER = REGISTRY.register(data.get(525));
        LILAC = REGISTRY.register(data.get(526));
        ROSE_BUSH = REGISTRY.register(data.get(527));
        PEONY = REGISTRY.register(data.get(528));
        TALL_GRASS = REGISTRY.register(data.get(529));
        LARGE_FERN = REGISTRY.register(data.get(530));
        WHITE_STAINED_GLASS = REGISTRY.register(data.get(531));
        ORANGE_STAINED_GLASS = REGISTRY.register(data.get(532));
        MAGENTA_STAINED_GLASS = REGISTRY.register(data.get(533));
        LIGHT_BLUE_STAINED_GLASS = REGISTRY.register(data.get(534));
        YELLOW_STAINED_GLASS = REGISTRY.register(data.get(535));
        LIME_STAINED_GLASS = REGISTRY.register(data.get(536));
        PINK_STAINED_GLASS = REGISTRY.register(data.get(537));
        GRAY_STAINED_GLASS = REGISTRY.register(data.get(538));
        LIGHT_GRAY_STAINED_GLASS = REGISTRY.register(data.get(539));
        CYAN_STAINED_GLASS = REGISTRY.register(data.get(540));
        PURPLE_STAINED_GLASS = REGISTRY.register(data.get(541));
        BLUE_STAINED_GLASS = REGISTRY.register(data.get(542));
        BROWN_STAINED_GLASS = REGISTRY.register(data.get(543));
        GREEN_STAINED_GLASS = REGISTRY.register(data.get(544));
        RED_STAINED_GLASS = REGISTRY.register(data.get(545));
        BLACK_STAINED_GLASS = REGISTRY.register(data.get(546));
        WHITE_STAINED_GLASS_PANE = REGISTRY.register(data.get(547));
        ORANGE_STAINED_GLASS_PANE = REGISTRY.register(data.get(548));
        MAGENTA_STAINED_GLASS_PANE = REGISTRY.register(data.get(549));
        LIGHT_BLUE_STAINED_GLASS_PANE = REGISTRY.register(data.get(550));
        YELLOW_STAINED_GLASS_PANE = REGISTRY.register(data.get(551));
        LIME_STAINED_GLASS_PANE = REGISTRY.register(data.get(552));
        PINK_STAINED_GLASS_PANE = REGISTRY.register(data.get(553));
        GRAY_STAINED_GLASS_PANE = REGISTRY.register(data.get(554));
        LIGHT_GRAY_STAINED_GLASS_PANE = REGISTRY.register(data.get(555));
        CYAN_STAINED_GLASS_PANE = REGISTRY.register(data.get(556));
        PURPLE_STAINED_GLASS_PANE = REGISTRY.register(data.get(557));
        BLUE_STAINED_GLASS_PANE = REGISTRY.register(data.get(558));
        BROWN_STAINED_GLASS_PANE = REGISTRY.register(data.get(559));
        GREEN_STAINED_GLASS_PANE = REGISTRY.register(data.get(560));
        RED_STAINED_GLASS_PANE = REGISTRY.register(data.get(561));
        BLACK_STAINED_GLASS_PANE = REGISTRY.register(data.get(562));
        PRISMARINE = REGISTRY.register(data.get(563));
        PRISMARINE_BRICKS = REGISTRY.register(data.get(564));
        DARK_PRISMARINE = REGISTRY.register(data.get(565));
        PRISMARINE_STAIRS = REGISTRY.register(data.get(566));
        PRISMARINE_BRICK_STAIRS = REGISTRY.register(data.get(567));
        DARK_PRISMARINE_STAIRS = REGISTRY.register(data.get(568));
        SEA_LANTERN = REGISTRY.register(data.get(569));
        RED_SANDSTONE = REGISTRY.register(data.get(570));
        CHISELED_RED_SANDSTONE = REGISTRY.register(data.get(571));
        CUT_RED_SANDSTONE = REGISTRY.register(data.get(572));
        RED_SANDSTONE_STAIRS = REGISTRY.register(data.get(573));
        REPEATING_COMMAND_BLOCK = REGISTRY.register(data.get(574));
        CHAIN_COMMAND_BLOCK = REGISTRY.register(data.get(575));
        MAGMA_BLOCK = REGISTRY.register(data.get(576));
        NETHER_WART_BLOCK = REGISTRY.register(data.get(577));
        WARPED_WART_BLOCK = REGISTRY.register(data.get(578));
        RED_NETHER_BRICKS = REGISTRY.register(data.get(579));
        BONE_BLOCK = REGISTRY.register(data.get(580));
        STRUCTURE_VOID = REGISTRY.register(data.get(581));
        SHULKER_BOX = REGISTRY.register(data.get(582));
        WHITE_SHULKER_BOX = REGISTRY.register(data.get(583));
        ORANGE_SHULKER_BOX = REGISTRY.register(data.get(584));
        MAGENTA_SHULKER_BOX = REGISTRY.register(data.get(585));
        LIGHT_BLUE_SHULKER_BOX = REGISTRY.register(data.get(586));
        YELLOW_SHULKER_BOX = REGISTRY.register(data.get(587));
        LIME_SHULKER_BOX = REGISTRY.register(data.get(588));
        PINK_SHULKER_BOX = REGISTRY.register(data.get(589));
        GRAY_SHULKER_BOX = REGISTRY.register(data.get(590));
        LIGHT_GRAY_SHULKER_BOX = REGISTRY.register(data.get(591));
        CYAN_SHULKER_BOX = REGISTRY.register(data.get(592));
        PURPLE_SHULKER_BOX = REGISTRY.register(data.get(593));
        BLUE_SHULKER_BOX = REGISTRY.register(data.get(594));
        BROWN_SHULKER_BOX = REGISTRY.register(data.get(595));
        GREEN_SHULKER_BOX = REGISTRY.register(data.get(596));
        RED_SHULKER_BOX = REGISTRY.register(data.get(597));
        BLACK_SHULKER_BOX = REGISTRY.register(data.get(598));
        WHITE_GLAZED_TERRACOTTA = REGISTRY.register(data.get(599));
        ORANGE_GLAZED_TERRACOTTA = REGISTRY.register(data.get(600));
        MAGENTA_GLAZED_TERRACOTTA = REGISTRY.register(data.get(601));
        LIGHT_BLUE_GLAZED_TERRACOTTA = REGISTRY.register(data.get(602));
        YELLOW_GLAZED_TERRACOTTA = REGISTRY.register(data.get(603));
        LIME_GLAZED_TERRACOTTA = REGISTRY.register(data.get(604));
        PINK_GLAZED_TERRACOTTA = REGISTRY.register(data.get(605));
        GRAY_GLAZED_TERRACOTTA = REGISTRY.register(data.get(606));
        LIGHT_GRAY_GLAZED_TERRACOTTA = REGISTRY.register(data.get(607));
        CYAN_GLAZED_TERRACOTTA = REGISTRY.register(data.get(608));
        PURPLE_GLAZED_TERRACOTTA = REGISTRY.register(data.get(609));
        BLUE_GLAZED_TERRACOTTA = REGISTRY.register(data.get(610));
        BROWN_GLAZED_TERRACOTTA = REGISTRY.register(data.get(611));
        GREEN_GLAZED_TERRACOTTA = REGISTRY.register(data.get(612));
        RED_GLAZED_TERRACOTTA = REGISTRY.register(data.get(613));
        BLACK_GLAZED_TERRACOTTA = REGISTRY.register(data.get(614));
        WHITE_CONCRETE = REGISTRY.register(data.get(615));
        ORANGE_CONCRETE = REGISTRY.register(data.get(616));
        MAGENTA_CONCRETE = REGISTRY.register(data.get(617));
        LIGHT_BLUE_CONCRETE = REGISTRY.register(data.get(618));
        YELLOW_CONCRETE = REGISTRY.register(data.get(619));
        LIME_CONCRETE = REGISTRY.register(data.get(620));
        PINK_CONCRETE = REGISTRY.register(data.get(621));
        GRAY_CONCRETE = REGISTRY.register(data.get(622));
        LIGHT_GRAY_CONCRETE = REGISTRY.register(data.get(623));
        CYAN_CONCRETE = REGISTRY.register(data.get(624));
        PURPLE_CONCRETE = REGISTRY.register(data.get(625));
        BLUE_CONCRETE = REGISTRY.register(data.get(626));
        BROWN_CONCRETE = REGISTRY.register(data.get(627));
        GREEN_CONCRETE = REGISTRY.register(data.get(628));
        RED_CONCRETE = REGISTRY.register(data.get(629));
        BLACK_CONCRETE = REGISTRY.register(data.get(630));
        WHITE_CONCRETE_POWDER = REGISTRY.register(data.get(631));
        ORANGE_CONCRETE_POWDER = REGISTRY.register(data.get(632));
        MAGENTA_CONCRETE_POWDER = REGISTRY.register(data.get(633));
        LIGHT_BLUE_CONCRETE_POWDER = REGISTRY.register(data.get(634));
        YELLOW_CONCRETE_POWDER = REGISTRY.register(data.get(635));
        LIME_CONCRETE_POWDER = REGISTRY.register(data.get(636));
        PINK_CONCRETE_POWDER = REGISTRY.register(data.get(637));
        GRAY_CONCRETE_POWDER = REGISTRY.register(data.get(638));
        LIGHT_GRAY_CONCRETE_POWDER = REGISTRY.register(data.get(639));
        CYAN_CONCRETE_POWDER = REGISTRY.register(data.get(640));
        PURPLE_CONCRETE_POWDER = REGISTRY.register(data.get(641));
        BLUE_CONCRETE_POWDER = REGISTRY.register(data.get(642));
        BROWN_CONCRETE_POWDER = REGISTRY.register(data.get(643));
        GREEN_CONCRETE_POWDER = REGISTRY.register(data.get(644));
        RED_CONCRETE_POWDER = REGISTRY.register(data.get(645));
        BLACK_CONCRETE_POWDER = REGISTRY.register(data.get(646));
        TURTLE_EGG = REGISTRY.register(data.get(647));
        SNIFFER_EGG = REGISTRY.register(data.get(648));
        DRIED_GHAST = REGISTRY.register(data.get(649));
        DEAD_TUBE_CORAL_BLOCK = REGISTRY.register(data.get(650));
        DEAD_BRAIN_CORAL_BLOCK = REGISTRY.register(data.get(651));
        DEAD_BUBBLE_CORAL_BLOCK = REGISTRY.register(data.get(652));
        DEAD_FIRE_CORAL_BLOCK = REGISTRY.register(data.get(653));
        DEAD_HORN_CORAL_BLOCK = REGISTRY.register(data.get(654));
        TUBE_CORAL_BLOCK = REGISTRY.register(data.get(655));
        BRAIN_CORAL_BLOCK = REGISTRY.register(data.get(656));
        BUBBLE_CORAL_BLOCK = REGISTRY.register(data.get(657));
        FIRE_CORAL_BLOCK = REGISTRY.register(data.get(658));
        HORN_CORAL_BLOCK = REGISTRY.register(data.get(659));
        TUBE_CORAL = REGISTRY.register(data.get(660));
        BRAIN_CORAL = REGISTRY.register(data.get(661));
        BUBBLE_CORAL = REGISTRY.register(data.get(662));
        FIRE_CORAL = REGISTRY.register(data.get(663));
        HORN_CORAL = REGISTRY.register(data.get(664));
        DEAD_BRAIN_CORAL = REGISTRY.register(data.get(665));
        DEAD_BUBBLE_CORAL = REGISTRY.register(data.get(666));
        DEAD_FIRE_CORAL = REGISTRY.register(data.get(667));
        DEAD_HORN_CORAL = REGISTRY.register(data.get(668));
        DEAD_TUBE_CORAL = REGISTRY.register(data.get(669));
        TUBE_CORAL_FAN = REGISTRY.register(data.get(670));
        BRAIN_CORAL_FAN = REGISTRY.register(data.get(671));
        BUBBLE_CORAL_FAN = REGISTRY.register(data.get(672));
        FIRE_CORAL_FAN = REGISTRY.register(data.get(673));
        HORN_CORAL_FAN = REGISTRY.register(data.get(674));
        DEAD_TUBE_CORAL_FAN = REGISTRY.register(data.get(675));
        DEAD_BRAIN_CORAL_FAN = REGISTRY.register(data.get(676));
        DEAD_BUBBLE_CORAL_FAN = REGISTRY.register(data.get(677));
        DEAD_FIRE_CORAL_FAN = REGISTRY.register(data.get(678));
        DEAD_HORN_CORAL_FAN = REGISTRY.register(data.get(679));
        BLUE_ICE = REGISTRY.register(data.get(680));
        CONDUIT = REGISTRY.register(data.get(681));
        POLISHED_GRANITE_STAIRS = REGISTRY.register(data.get(682));
        SMOOTH_RED_SANDSTONE_STAIRS = REGISTRY.register(data.get(683));
        MOSSY_STONE_BRICK_STAIRS = REGISTRY.register(data.get(684));
        POLISHED_DIORITE_STAIRS = REGISTRY.register(data.get(685));
        MOSSY_COBBLESTONE_STAIRS = REGISTRY.register(data.get(686));
        END_STONE_BRICK_STAIRS = REGISTRY.register(data.get(687));
        STONE_STAIRS = REGISTRY.register(data.get(688));
        SMOOTH_SANDSTONE_STAIRS = REGISTRY.register(data.get(689));
        SMOOTH_QUARTZ_STAIRS = REGISTRY.register(data.get(690));
        GRANITE_STAIRS = REGISTRY.register(data.get(691));
        ANDESITE_STAIRS = REGISTRY.register(data.get(692));
        RED_NETHER_BRICK_STAIRS = REGISTRY.register(data.get(693));
        POLISHED_ANDESITE_STAIRS = REGISTRY.register(data.get(694));
        DIORITE_STAIRS = REGISTRY.register(data.get(695));
        COBBLED_DEEPSLATE_STAIRS = REGISTRY.register(data.get(696));
        POLISHED_DEEPSLATE_STAIRS = REGISTRY.register(data.get(697));
        DEEPSLATE_BRICK_STAIRS = REGISTRY.register(data.get(698));
        DEEPSLATE_TILE_STAIRS = REGISTRY.register(data.get(699));
        POLISHED_GRANITE_SLAB = REGISTRY.register(data.get(700));
        SMOOTH_RED_SANDSTONE_SLAB = REGISTRY.register(data.get(701));
        MOSSY_STONE_BRICK_SLAB = REGISTRY.register(data.get(702));
        POLISHED_DIORITE_SLAB = REGISTRY.register(data.get(703));
        MOSSY_COBBLESTONE_SLAB = REGISTRY.register(data.get(704));
        END_STONE_BRICK_SLAB = REGISTRY.register(data.get(705));
        SMOOTH_SANDSTONE_SLAB = REGISTRY.register(data.get(706));
        SMOOTH_QUARTZ_SLAB = REGISTRY.register(data.get(707));
        GRANITE_SLAB = REGISTRY.register(data.get(708));
        ANDESITE_SLAB = REGISTRY.register(data.get(709));
        RED_NETHER_BRICK_SLAB = REGISTRY.register(data.get(710));
        POLISHED_ANDESITE_SLAB = REGISTRY.register(data.get(711));
        DIORITE_SLAB = REGISTRY.register(data.get(712));
        COBBLED_DEEPSLATE_SLAB = REGISTRY.register(data.get(713));
        POLISHED_DEEPSLATE_SLAB = REGISTRY.register(data.get(714));
        DEEPSLATE_BRICK_SLAB = REGISTRY.register(data.get(715));
        DEEPSLATE_TILE_SLAB = REGISTRY.register(data.get(716));
        SCAFFOLDING = REGISTRY.register(data.get(717));
        REDSTONE = REGISTRY.register(data.get(718));
        REDSTONE_TORCH = REGISTRY.register(data.get(719));
        REDSTONE_BLOCK = REGISTRY.register(data.get(720));
        REPEATER = REGISTRY.register(data.get(721));
        COMPARATOR = REGISTRY.register(data.get(722));
        PISTON = REGISTRY.register(data.get(723));
        STICKY_PISTON = REGISTRY.register(data.get(724));
        SLIME_BLOCK = REGISTRY.register(data.get(725));
        HONEY_BLOCK = REGISTRY.register(data.get(726));
        OBSERVER = REGISTRY.register(data.get(727));
        HOPPER = REGISTRY.register(data.get(728));
        DISPENSER = REGISTRY.register(data.get(729));
        DROPPER = REGISTRY.register(data.get(730));
        LECTERN = REGISTRY.register(data.get(731));
        TARGET = REGISTRY.register(data.get(732));
        LEVER = REGISTRY.register(data.get(733));
        LIGHTNING_ROD = REGISTRY.register(data.get(734));
        EXPOSED_LIGHTNING_ROD = REGISTRY.register(data.get(735));
        WEATHERED_LIGHTNING_ROD = REGISTRY.register(data.get(736));
        OXIDIZED_LIGHTNING_ROD = REGISTRY.register(data.get(737));
        WAXED_LIGHTNING_ROD = REGISTRY.register(data.get(738));
        WAXED_EXPOSED_LIGHTNING_ROD = REGISTRY.register(data.get(739));
        WAXED_WEATHERED_LIGHTNING_ROD = REGISTRY.register(data.get(740));
        WAXED_OXIDIZED_LIGHTNING_ROD = REGISTRY.register(data.get(741));
        DAYLIGHT_DETECTOR = REGISTRY.register(data.get(742));
        SCULK_SENSOR = REGISTRY.register(data.get(743));
        CALIBRATED_SCULK_SENSOR = REGISTRY.register(data.get(744));
        TRIPWIRE_HOOK = REGISTRY.register(data.get(745));
        TRAPPED_CHEST = REGISTRY.register(data.get(746));
        TNT = REGISTRY.register(data.get(747));
        REDSTONE_LAMP = REGISTRY.register(data.get(748));
        NOTE_BLOCK = REGISTRY.register(data.get(749));
        STONE_BUTTON = REGISTRY.register(data.get(750));
        POLISHED_BLACKSTONE_BUTTON = REGISTRY.register(data.get(751));
        OAK_BUTTON = REGISTRY.register(data.get(752));
        SPRUCE_BUTTON = REGISTRY.register(data.get(753));
        BIRCH_BUTTON = REGISTRY.register(data.get(754));
        JUNGLE_BUTTON = REGISTRY.register(data.get(755));
        ACACIA_BUTTON = REGISTRY.register(data.get(756));
        CHERRY_BUTTON = REGISTRY.register(data.get(757));
        DARK_OAK_BUTTON = REGISTRY.register(data.get(758));
        PALE_OAK_BUTTON = REGISTRY.register(data.get(759));
        MANGROVE_BUTTON = REGISTRY.register(data.get(760));
        BAMBOO_BUTTON = REGISTRY.register(data.get(761));
        CRIMSON_BUTTON = REGISTRY.register(data.get(762));
        WARPED_BUTTON = REGISTRY.register(data.get(763));
        STONE_PRESSURE_PLATE = REGISTRY.register(data.get(764));
        POLISHED_BLACKSTONE_PRESSURE_PLATE = REGISTRY.register(data.get(765));
        LIGHT_WEIGHTED_PRESSURE_PLATE = REGISTRY.register(data.get(766));
        HEAVY_WEIGHTED_PRESSURE_PLATE = REGISTRY.register(data.get(767));
        OAK_PRESSURE_PLATE = REGISTRY.register(data.get(768));
        SPRUCE_PRESSURE_PLATE = REGISTRY.register(data.get(769));
        BIRCH_PRESSURE_PLATE = REGISTRY.register(data.get(770));
        JUNGLE_PRESSURE_PLATE = REGISTRY.register(data.get(771));
        ACACIA_PRESSURE_PLATE = REGISTRY.register(data.get(772));
        CHERRY_PRESSURE_PLATE = REGISTRY.register(data.get(773));
        DARK_OAK_PRESSURE_PLATE = REGISTRY.register(data.get(774));
        PALE_OAK_PRESSURE_PLATE = REGISTRY.register(data.get(775));
        MANGROVE_PRESSURE_PLATE = REGISTRY.register(data.get(776));
        BAMBOO_PRESSURE_PLATE = REGISTRY.register(data.get(777));
        CRIMSON_PRESSURE_PLATE = REGISTRY.register(data.get(778));
        WARPED_PRESSURE_PLATE = REGISTRY.register(data.get(779));
        IRON_DOOR = REGISTRY.register(data.get(780));
        OAK_DOOR = REGISTRY.register(data.get(781));
        SPRUCE_DOOR = REGISTRY.register(data.get(782));
        BIRCH_DOOR = REGISTRY.register(data.get(783));
        JUNGLE_DOOR = REGISTRY.register(data.get(784));
        ACACIA_DOOR = REGISTRY.register(data.get(785));
        CHERRY_DOOR = REGISTRY.register(data.get(786));
        DARK_OAK_DOOR = REGISTRY.register(data.get(787));
        PALE_OAK_DOOR = REGISTRY.register(data.get(788));
        MANGROVE_DOOR = REGISTRY.register(data.get(789));
        BAMBOO_DOOR = REGISTRY.register(data.get(790));
        CRIMSON_DOOR = REGISTRY.register(data.get(791));
        WARPED_DOOR = REGISTRY.register(data.get(792));
        COPPER_DOOR = REGISTRY.register(data.get(793));
        EXPOSED_COPPER_DOOR = REGISTRY.register(data.get(794));
        WEATHERED_COPPER_DOOR = REGISTRY.register(data.get(795));
        OXIDIZED_COPPER_DOOR = REGISTRY.register(data.get(796));
        WAXED_COPPER_DOOR = REGISTRY.register(data.get(797));
        WAXED_EXPOSED_COPPER_DOOR = REGISTRY.register(data.get(798));
        WAXED_WEATHERED_COPPER_DOOR = REGISTRY.register(data.get(799));
        WAXED_OXIDIZED_COPPER_DOOR = REGISTRY.register(data.get(800));
        IRON_TRAPDOOR = REGISTRY.register(data.get(801));
        OAK_TRAPDOOR = REGISTRY.register(data.get(802));
        SPRUCE_TRAPDOOR = REGISTRY.register(data.get(803));
        BIRCH_TRAPDOOR = REGISTRY.register(data.get(804));
        JUNGLE_TRAPDOOR = REGISTRY.register(data.get(805));
        ACACIA_TRAPDOOR = REGISTRY.register(data.get(806));
        CHERRY_TRAPDOOR = REGISTRY.register(data.get(807));
        DARK_OAK_TRAPDOOR = REGISTRY.register(data.get(808));
        PALE_OAK_TRAPDOOR = REGISTRY.register(data.get(809));
        MANGROVE_TRAPDOOR = REGISTRY.register(data.get(810));
        BAMBOO_TRAPDOOR = REGISTRY.register(data.get(811));
        CRIMSON_TRAPDOOR = REGISTRY.register(data.get(812));
        WARPED_TRAPDOOR = REGISTRY.register(data.get(813));
        COPPER_TRAPDOOR = REGISTRY.register(data.get(814));
        EXPOSED_COPPER_TRAPDOOR = REGISTRY.register(data.get(815));
        WEATHERED_COPPER_TRAPDOOR = REGISTRY.register(data.get(816));
        OXIDIZED_COPPER_TRAPDOOR = REGISTRY.register(data.get(817));
        WAXED_COPPER_TRAPDOOR = REGISTRY.register(data.get(818));
        WAXED_EXPOSED_COPPER_TRAPDOOR = REGISTRY.register(data.get(819));
        WAXED_WEATHERED_COPPER_TRAPDOOR = REGISTRY.register(data.get(820));
        WAXED_OXIDIZED_COPPER_TRAPDOOR = REGISTRY.register(data.get(821));
        OAK_FENCE_GATE = REGISTRY.register(data.get(822));
        SPRUCE_FENCE_GATE = REGISTRY.register(data.get(823));
        BIRCH_FENCE_GATE = REGISTRY.register(data.get(824));
        JUNGLE_FENCE_GATE = REGISTRY.register(data.get(825));
        ACACIA_FENCE_GATE = REGISTRY.register(data.get(826));
        CHERRY_FENCE_GATE = REGISTRY.register(data.get(827));
        DARK_OAK_FENCE_GATE = REGISTRY.register(data.get(828));
        PALE_OAK_FENCE_GATE = REGISTRY.register(data.get(829));
        MANGROVE_FENCE_GATE = REGISTRY.register(data.get(830));
        BAMBOO_FENCE_GATE = REGISTRY.register(data.get(831));
        CRIMSON_FENCE_GATE = REGISTRY.register(data.get(832));
        WARPED_FENCE_GATE = REGISTRY.register(data.get(833));
        POWERED_RAIL = REGISTRY.register(data.get(834));
        DETECTOR_RAIL = REGISTRY.register(data.get(835));
        RAIL = REGISTRY.register(data.get(836));
        ACTIVATOR_RAIL = REGISTRY.register(data.get(837));
        SADDLE = REGISTRY.register(data.get(838));
        WHITE_HARNESS = REGISTRY.register(data.get(839));
        ORANGE_HARNESS = REGISTRY.register(data.get(840));
        MAGENTA_HARNESS = REGISTRY.register(data.get(841));
        LIGHT_BLUE_HARNESS = REGISTRY.register(data.get(842));
        YELLOW_HARNESS = REGISTRY.register(data.get(843));
        LIME_HARNESS = REGISTRY.register(data.get(844));
        PINK_HARNESS = REGISTRY.register(data.get(845));
        GRAY_HARNESS = REGISTRY.register(data.get(846));
        LIGHT_GRAY_HARNESS = REGISTRY.register(data.get(847));
        CYAN_HARNESS = REGISTRY.register(data.get(848));
        PURPLE_HARNESS = REGISTRY.register(data.get(849));
        BLUE_HARNESS = REGISTRY.register(data.get(850));
        BROWN_HARNESS = REGISTRY.register(data.get(851));
        GREEN_HARNESS = REGISTRY.register(data.get(852));
        RED_HARNESS = REGISTRY.register(data.get(853));
        BLACK_HARNESS = REGISTRY.register(data.get(854));
        MINECART = REGISTRY.register(data.get(855));
        CHEST_MINECART = REGISTRY.register(data.get(856));
        FURNACE_MINECART = REGISTRY.register(data.get(857));
        TNT_MINECART = REGISTRY.register(data.get(858));
        HOPPER_MINECART = REGISTRY.register(data.get(859));
        CARROT_ON_A_STICK = REGISTRY.register(data.get(860));
        WARPED_FUNGUS_ON_A_STICK = REGISTRY.register(data.get(861));
        PHANTOM_MEMBRANE = REGISTRY.register(data.get(862));
        ELYTRA = REGISTRY.register(data.get(863));
        OAK_BOAT = REGISTRY.register(data.get(864));
        OAK_CHEST_BOAT = REGISTRY.register(data.get(865));
        SPRUCE_BOAT = REGISTRY.register(data.get(866));
        SPRUCE_CHEST_BOAT = REGISTRY.register(data.get(867));
        BIRCH_BOAT = REGISTRY.register(data.get(868));
        BIRCH_CHEST_BOAT = REGISTRY.register(data.get(869));
        JUNGLE_BOAT = REGISTRY.register(data.get(870));
        JUNGLE_CHEST_BOAT = REGISTRY.register(data.get(871));
        ACACIA_BOAT = REGISTRY.register(data.get(872));
        ACACIA_CHEST_BOAT = REGISTRY.register(data.get(873));
        CHERRY_BOAT = REGISTRY.register(data.get(874));
        CHERRY_CHEST_BOAT = REGISTRY.register(data.get(875));
        DARK_OAK_BOAT = REGISTRY.register(data.get(876));
        DARK_OAK_CHEST_BOAT = REGISTRY.register(data.get(877));
        PALE_OAK_BOAT = REGISTRY.register(data.get(878));
        PALE_OAK_CHEST_BOAT = REGISTRY.register(data.get(879));
        MANGROVE_BOAT = REGISTRY.register(data.get(880));
        MANGROVE_CHEST_BOAT = REGISTRY.register(data.get(881));
        BAMBOO_RAFT = REGISTRY.register(data.get(882));
        BAMBOO_CHEST_RAFT = REGISTRY.register(data.get(883));
        STRUCTURE_BLOCK = REGISTRY.register(data.get(884));
        JIGSAW = REGISTRY.register(data.get(885));
        TEST_BLOCK = REGISTRY.register(data.get(886));
        TEST_INSTANCE_BLOCK = REGISTRY.register(data.get(887));
        TURTLE_HELMET = REGISTRY.register(data.get(888));
        TURTLE_SCUTE = REGISTRY.register(data.get(889));
        ARMADILLO_SCUTE = REGISTRY.register(data.get(890));
        WOLF_ARMOR = REGISTRY.register(data.get(891));
        FLINT_AND_STEEL = REGISTRY.register(data.get(892));
        BOWL = REGISTRY.register(data.get(893));
        APPLE = REGISTRY.register(data.get(894));
        BOW = REGISTRY.register(data.get(895));
        ARROW = REGISTRY.register(data.get(896));
        COAL = REGISTRY.register(data.get(897));
        CHARCOAL = REGISTRY.register(data.get(898));
        DIAMOND = REGISTRY.register(data.get(899));
        EMERALD = REGISTRY.register(data.get(900));
        LAPIS_LAZULI = REGISTRY.register(data.get(901));
        QUARTZ = REGISTRY.register(data.get(902));
        AMETHYST_SHARD = REGISTRY.register(data.get(903));
        RAW_IRON = REGISTRY.register(data.get(904));
        IRON_INGOT = REGISTRY.register(data.get(905));
        RAW_COPPER = REGISTRY.register(data.get(906));
        COPPER_INGOT = REGISTRY.register(data.get(907));
        RAW_GOLD = REGISTRY.register(data.get(908));
        GOLD_INGOT = REGISTRY.register(data.get(909));
        NETHERITE_INGOT = REGISTRY.register(data.get(910));
        NETHERITE_SCRAP = REGISTRY.register(data.get(911));
        WOODEN_SWORD = REGISTRY.register(data.get(912));
        WOODEN_SHOVEL = REGISTRY.register(data.get(913));
        WOODEN_PICKAXE = REGISTRY.register(data.get(914));
        WOODEN_AXE = REGISTRY.register(data.get(915));
        WOODEN_HOE = REGISTRY.register(data.get(916));
        COPPER_SWORD = REGISTRY.register(data.get(917));
        COPPER_SHOVEL = REGISTRY.register(data.get(918));
        COPPER_PICKAXE = REGISTRY.register(data.get(919));
        COPPER_AXE = REGISTRY.register(data.get(920));
        COPPER_HOE = REGISTRY.register(data.get(921));
        STONE_SWORD = REGISTRY.register(data.get(922));
        STONE_SHOVEL = REGISTRY.register(data.get(923));
        STONE_PICKAXE = REGISTRY.register(data.get(924));
        STONE_AXE = REGISTRY.register(data.get(925));
        STONE_HOE = REGISTRY.register(data.get(926));
        GOLDEN_SWORD = REGISTRY.register(data.get(927));
        GOLDEN_SHOVEL = REGISTRY.register(data.get(928));
        GOLDEN_PICKAXE = REGISTRY.register(data.get(929));
        GOLDEN_AXE = REGISTRY.register(data.get(930));
        GOLDEN_HOE = REGISTRY.register(data.get(931));
        IRON_SWORD = REGISTRY.register(data.get(932));
        IRON_SHOVEL = REGISTRY.register(data.get(933));
        IRON_PICKAXE = REGISTRY.register(data.get(934));
        IRON_AXE = REGISTRY.register(data.get(935));
        IRON_HOE = REGISTRY.register(data.get(936));
        DIAMOND_SWORD = REGISTRY.register(data.get(937));
        DIAMOND_SHOVEL = REGISTRY.register(data.get(938));
        DIAMOND_PICKAXE = REGISTRY.register(data.get(939));
        DIAMOND_AXE = REGISTRY.register(data.get(940));
        DIAMOND_HOE = REGISTRY.register(data.get(941));
        NETHERITE_SWORD = REGISTRY.register(data.get(942));
        NETHERITE_SHOVEL = REGISTRY.register(data.get(943));
        NETHERITE_PICKAXE = REGISTRY.register(data.get(944));
        NETHERITE_AXE = REGISTRY.register(data.get(945));
        NETHERITE_HOE = REGISTRY.register(data.get(946));
        STICK = REGISTRY.register(data.get(947));
        MUSHROOM_STEW = REGISTRY.register(data.get(948));
        STRING = REGISTRY.register(data.get(949));
        FEATHER = REGISTRY.register(data.get(950));
        GUNPOWDER = REGISTRY.register(data.get(951));
        WHEAT_SEEDS = REGISTRY.register(data.get(952));
        WHEAT = REGISTRY.register(data.get(953));
        BREAD = REGISTRY.register(data.get(954));
        LEATHER_HELMET = REGISTRY.register(data.get(955));
        LEATHER_CHESTPLATE = REGISTRY.register(data.get(956));
        LEATHER_LEGGINGS = REGISTRY.register(data.get(957));
        LEATHER_BOOTS = REGISTRY.register(data.get(958));
        COPPER_HELMET = REGISTRY.register(data.get(959));
        COPPER_CHESTPLATE = REGISTRY.register(data.get(960));
        COPPER_LEGGINGS = REGISTRY.register(data.get(961));
        COPPER_BOOTS = REGISTRY.register(data.get(962));
        CHAINMAIL_HELMET = REGISTRY.register(data.get(963));
        CHAINMAIL_CHESTPLATE = REGISTRY.register(data.get(964));
        CHAINMAIL_LEGGINGS = REGISTRY.register(data.get(965));
        CHAINMAIL_BOOTS = REGISTRY.register(data.get(966));
        IRON_HELMET = REGISTRY.register(data.get(967));
        IRON_CHESTPLATE = REGISTRY.register(data.get(968));
        IRON_LEGGINGS = REGISTRY.register(data.get(969));
        IRON_BOOTS = REGISTRY.register(data.get(970));
        DIAMOND_HELMET = REGISTRY.register(data.get(971));
        DIAMOND_CHESTPLATE = REGISTRY.register(data.get(972));
        DIAMOND_LEGGINGS = REGISTRY.register(data.get(973));
        DIAMOND_BOOTS = REGISTRY.register(data.get(974));
        GOLDEN_HELMET = REGISTRY.register(data.get(975));
        GOLDEN_CHESTPLATE = REGISTRY.register(data.get(976));
        GOLDEN_LEGGINGS = REGISTRY.register(data.get(977));
        GOLDEN_BOOTS = REGISTRY.register(data.get(978));
        NETHERITE_HELMET = REGISTRY.register(data.get(979));
        NETHERITE_CHESTPLATE = REGISTRY.register(data.get(980));
        NETHERITE_LEGGINGS = REGISTRY.register(data.get(981));
        NETHERITE_BOOTS = REGISTRY.register(data.get(982));
        FLINT = REGISTRY.register(data.get(983));
        PORKCHOP = REGISTRY.register(data.get(984));
        COOKED_PORKCHOP = REGISTRY.register(data.get(985));
        PAINTING = REGISTRY.register(data.get(986));
        GOLDEN_APPLE = REGISTRY.register(data.get(987));
        ENCHANTED_GOLDEN_APPLE = REGISTRY.register(data.get(988));
        OAK_SIGN = REGISTRY.register(data.get(989));
        SPRUCE_SIGN = REGISTRY.register(data.get(990));
        BIRCH_SIGN = REGISTRY.register(data.get(991));
        JUNGLE_SIGN = REGISTRY.register(data.get(992));
        ACACIA_SIGN = REGISTRY.register(data.get(993));
        CHERRY_SIGN = REGISTRY.register(data.get(994));
        DARK_OAK_SIGN = REGISTRY.register(data.get(995));
        PALE_OAK_SIGN = REGISTRY.register(data.get(996));
        MANGROVE_SIGN = REGISTRY.register(data.get(997));
        BAMBOO_SIGN = REGISTRY.register(data.get(998));
        CRIMSON_SIGN = REGISTRY.register(data.get(999));
        WARPED_SIGN = REGISTRY.register(data.get(1000));
        OAK_HANGING_SIGN = REGISTRY.register(data.get(1001));
        SPRUCE_HANGING_SIGN = REGISTRY.register(data.get(1002));
        BIRCH_HANGING_SIGN = REGISTRY.register(data.get(1003));
        JUNGLE_HANGING_SIGN = REGISTRY.register(data.get(1004));
        ACACIA_HANGING_SIGN = REGISTRY.register(data.get(1005));
        CHERRY_HANGING_SIGN = REGISTRY.register(data.get(1006));
        DARK_OAK_HANGING_SIGN = REGISTRY.register(data.get(1007));
        PALE_OAK_HANGING_SIGN = REGISTRY.register(data.get(1008));
        MANGROVE_HANGING_SIGN = REGISTRY.register(data.get(1009));
        BAMBOO_HANGING_SIGN = REGISTRY.register(data.get(1010));
        CRIMSON_HANGING_SIGN = REGISTRY.register(data.get(1011));
        WARPED_HANGING_SIGN = REGISTRY.register(data.get(1012));
        BUCKET = REGISTRY.register(data.get(1013));
        WATER_BUCKET = REGISTRY.register(data.get(1014));
        LAVA_BUCKET = REGISTRY.register(data.get(1015));
        POWDER_SNOW_BUCKET = REGISTRY.register(data.get(1016));
        SNOWBALL = REGISTRY.register(data.get(1017));
        LEATHER = REGISTRY.register(data.get(1018));
        MILK_BUCKET = REGISTRY.register(data.get(1019));
        PUFFERFISH_BUCKET = REGISTRY.register(data.get(1020));
        SALMON_BUCKET = REGISTRY.register(data.get(1021));
        COD_BUCKET = REGISTRY.register(data.get(1022));
        TROPICAL_FISH_BUCKET = REGISTRY.register(data.get(1023));
        AXOLOTL_BUCKET = REGISTRY.register(data.get(1024));
        TADPOLE_BUCKET = REGISTRY.register(data.get(1025));
        BRICK = REGISTRY.register(data.get(1026));
        CLAY_BALL = REGISTRY.register(data.get(1027));
        DRIED_KELP_BLOCK = REGISTRY.register(data.get(1028));
        PAPER = REGISTRY.register(data.get(1029));
        BOOK = REGISTRY.register(data.get(1030));
        SLIME_BALL = REGISTRY.register(data.get(1031));
        EGG = REGISTRY.register(data.get(1032));
        BLUE_EGG = REGISTRY.register(data.get(1033));
        BROWN_EGG = REGISTRY.register(data.get(1034));
        COMPASS = REGISTRY.register(data.get(1035));
        RECOVERY_COMPASS = REGISTRY.register(data.get(1036));
        BUNDLE = REGISTRY.register(data.get(1037));
        WHITE_BUNDLE = REGISTRY.register(data.get(1038));
        ORANGE_BUNDLE = REGISTRY.register(data.get(1039));
        MAGENTA_BUNDLE = REGISTRY.register(data.get(1040));
        LIGHT_BLUE_BUNDLE = REGISTRY.register(data.get(1041));
        YELLOW_BUNDLE = REGISTRY.register(data.get(1042));
        LIME_BUNDLE = REGISTRY.register(data.get(1043));
        PINK_BUNDLE = REGISTRY.register(data.get(1044));
        GRAY_BUNDLE = REGISTRY.register(data.get(1045));
        LIGHT_GRAY_BUNDLE = REGISTRY.register(data.get(1046));
        CYAN_BUNDLE = REGISTRY.register(data.get(1047));
        PURPLE_BUNDLE = REGISTRY.register(data.get(1048));
        BLUE_BUNDLE = REGISTRY.register(data.get(1049));
        BROWN_BUNDLE = REGISTRY.register(data.get(1050));
        GREEN_BUNDLE = REGISTRY.register(data.get(1051));
        RED_BUNDLE = REGISTRY.register(data.get(1052));
        BLACK_BUNDLE = REGISTRY.register(data.get(1053));
        FISHING_ROD = REGISTRY.register(data.get(1054));
        CLOCK = REGISTRY.register(data.get(1055));
        SPYGLASS = REGISTRY.register(data.get(1056));
        GLOWSTONE_DUST = REGISTRY.register(data.get(1057));
        COD = REGISTRY.register(data.get(1058));
        SALMON = REGISTRY.register(data.get(1059));
        TROPICAL_FISH = REGISTRY.register(data.get(1060));
        PUFFERFISH = REGISTRY.register(data.get(1061));
        COOKED_COD = REGISTRY.register(data.get(1062));
        COOKED_SALMON = REGISTRY.register(data.get(1063));
        INK_SAC = REGISTRY.register(data.get(1064));
        GLOW_INK_SAC = REGISTRY.register(data.get(1065));
        COCOA_BEANS = REGISTRY.register(data.get(1066));
        WHITE_DYE = REGISTRY.register(data.get(1067));
        ORANGE_DYE = REGISTRY.register(data.get(1068));
        MAGENTA_DYE = REGISTRY.register(data.get(1069));
        LIGHT_BLUE_DYE = REGISTRY.register(data.get(1070));
        YELLOW_DYE = REGISTRY.register(data.get(1071));
        LIME_DYE = REGISTRY.register(data.get(1072));
        PINK_DYE = REGISTRY.register(data.get(1073));
        GRAY_DYE = REGISTRY.register(data.get(1074));
        LIGHT_GRAY_DYE = REGISTRY.register(data.get(1075));
        CYAN_DYE = REGISTRY.register(data.get(1076));
        PURPLE_DYE = REGISTRY.register(data.get(1077));
        BLUE_DYE = REGISTRY.register(data.get(1078));
        BROWN_DYE = REGISTRY.register(data.get(1079));
        GREEN_DYE = REGISTRY.register(data.get(1080));
        RED_DYE = REGISTRY.register(data.get(1081));
        BLACK_DYE = REGISTRY.register(data.get(1082));
        BONE_MEAL = REGISTRY.register(data.get(1083));
        BONE = REGISTRY.register(data.get(1084));
        SUGAR = REGISTRY.register(data.get(1085));
        CAKE = REGISTRY.register(data.get(1086));
        WHITE_BED = REGISTRY.register(data.get(1087));
        ORANGE_BED = REGISTRY.register(data.get(1088));
        MAGENTA_BED = REGISTRY.register(data.get(1089));
        LIGHT_BLUE_BED = REGISTRY.register(data.get(1090));
        YELLOW_BED = REGISTRY.register(data.get(1091));
        LIME_BED = REGISTRY.register(data.get(1092));
        PINK_BED = REGISTRY.register(data.get(1093));
        GRAY_BED = REGISTRY.register(data.get(1094));
        LIGHT_GRAY_BED = REGISTRY.register(data.get(1095));
        CYAN_BED = REGISTRY.register(data.get(1096));
        PURPLE_BED = REGISTRY.register(data.get(1097));
        BLUE_BED = REGISTRY.register(data.get(1098));
        BROWN_BED = REGISTRY.register(data.get(1099));
        GREEN_BED = REGISTRY.register(data.get(1100));
        RED_BED = REGISTRY.register(data.get(1101));
        BLACK_BED = REGISTRY.register(data.get(1102));
        COOKIE = REGISTRY.register(data.get(1103));
        CRAFTER = REGISTRY.register(data.get(1104));
        FILLED_MAP = REGISTRY.register(data.get(1105));
        SHEARS = REGISTRY.register(data.get(1106));
        MELON_SLICE = REGISTRY.register(data.get(1107));
        DRIED_KELP = REGISTRY.register(data.get(1108));
        PUMPKIN_SEEDS = REGISTRY.register(data.get(1109));
        MELON_SEEDS = REGISTRY.register(data.get(1110));
        BEEF = REGISTRY.register(data.get(1111));
        COOKED_BEEF = REGISTRY.register(data.get(1112));
        CHICKEN = REGISTRY.register(data.get(1113));
        COOKED_CHICKEN = REGISTRY.register(data.get(1114));
        ROTTEN_FLESH = REGISTRY.register(data.get(1115));
        ENDER_PEARL = REGISTRY.register(data.get(1116));
        BLAZE_ROD = REGISTRY.register(data.get(1117));
        GHAST_TEAR = REGISTRY.register(data.get(1118));
        GOLD_NUGGET = REGISTRY.register(data.get(1119));
        NETHER_WART = REGISTRY.register(data.get(1120));
        GLASS_BOTTLE = REGISTRY.register(data.get(1121));
        POTION = REGISTRY.register(data.get(1122));
        SPIDER_EYE = REGISTRY.register(data.get(1123));
        FERMENTED_SPIDER_EYE = REGISTRY.register(data.get(1124));
        BLAZE_POWDER = REGISTRY.register(data.get(1125));
        MAGMA_CREAM = REGISTRY.register(data.get(1126));
        BREWING_STAND = REGISTRY.register(data.get(1127));
        CAULDRON = REGISTRY.register(data.get(1128));
        ENDER_EYE = REGISTRY.register(data.get(1129));
        GLISTERING_MELON_SLICE = REGISTRY.register(data.get(1130));
        CHICKEN_SPAWN_EGG = REGISTRY.register(data.get(1131));
        COW_SPAWN_EGG = REGISTRY.register(data.get(1132));
        PIG_SPAWN_EGG = REGISTRY.register(data.get(1133));
        SHEEP_SPAWN_EGG = REGISTRY.register(data.get(1134));
        CAMEL_SPAWN_EGG = REGISTRY.register(data.get(1135));
        DONKEY_SPAWN_EGG = REGISTRY.register(data.get(1136));
        HORSE_SPAWN_EGG = REGISTRY.register(data.get(1137));
        MULE_SPAWN_EGG = REGISTRY.register(data.get(1138));
        CAT_SPAWN_EGG = REGISTRY.register(data.get(1139));
        PARROT_SPAWN_EGG = REGISTRY.register(data.get(1140));
        WOLF_SPAWN_EGG = REGISTRY.register(data.get(1141));
        ARMADILLO_SPAWN_EGG = REGISTRY.register(data.get(1142));
        BAT_SPAWN_EGG = REGISTRY.register(data.get(1143));
        BEE_SPAWN_EGG = REGISTRY.register(data.get(1144));
        FOX_SPAWN_EGG = REGISTRY.register(data.get(1145));
        GOAT_SPAWN_EGG = REGISTRY.register(data.get(1146));
        LLAMA_SPAWN_EGG = REGISTRY.register(data.get(1147));
        OCELOT_SPAWN_EGG = REGISTRY.register(data.get(1148));
        PANDA_SPAWN_EGG = REGISTRY.register(data.get(1149));
        POLAR_BEAR_SPAWN_EGG = REGISTRY.register(data.get(1150));
        RABBIT_SPAWN_EGG = REGISTRY.register(data.get(1151));
        AXOLOTL_SPAWN_EGG = REGISTRY.register(data.get(1152));
        COD_SPAWN_EGG = REGISTRY.register(data.get(1153));
        DOLPHIN_SPAWN_EGG = REGISTRY.register(data.get(1154));
        FROG_SPAWN_EGG = REGISTRY.register(data.get(1155));
        GLOW_SQUID_SPAWN_EGG = REGISTRY.register(data.get(1156));
        NAUTILUS_SPAWN_EGG = REGISTRY.register(data.get(1157));
        PUFFERFISH_SPAWN_EGG = REGISTRY.register(data.get(1158));
        SALMON_SPAWN_EGG = REGISTRY.register(data.get(1159));
        SQUID_SPAWN_EGG = REGISTRY.register(data.get(1160));
        TADPOLE_SPAWN_EGG = REGISTRY.register(data.get(1161));
        TROPICAL_FISH_SPAWN_EGG = REGISTRY.register(data.get(1162));
        TURTLE_SPAWN_EGG = REGISTRY.register(data.get(1163));
        ALLAY_SPAWN_EGG = REGISTRY.register(data.get(1164));
        MOOSHROOM_SPAWN_EGG = REGISTRY.register(data.get(1165));
        SNIFFER_SPAWN_EGG = REGISTRY.register(data.get(1166));
        COPPER_GOLEM_SPAWN_EGG = REGISTRY.register(data.get(1167));
        IRON_GOLEM_SPAWN_EGG = REGISTRY.register(data.get(1168));
        SNOW_GOLEM_SPAWN_EGG = REGISTRY.register(data.get(1169));
        TRADER_LLAMA_SPAWN_EGG = REGISTRY.register(data.get(1170));
        VILLAGER_SPAWN_EGG = REGISTRY.register(data.get(1171));
        WANDERING_TRADER_SPAWN_EGG = REGISTRY.register(data.get(1172));
        BOGGED_SPAWN_EGG = REGISTRY.register(data.get(1173));
        CAMEL_HUSK_SPAWN_EGG = REGISTRY.register(data.get(1174));
        DROWNED_SPAWN_EGG = REGISTRY.register(data.get(1175));
        HUSK_SPAWN_EGG = REGISTRY.register(data.get(1176));
        PARCHED_SPAWN_EGG = REGISTRY.register(data.get(1177));
        SKELETON_SPAWN_EGG = REGISTRY.register(data.get(1178));
        SKELETON_HORSE_SPAWN_EGG = REGISTRY.register(data.get(1179));
        STRAY_SPAWN_EGG = REGISTRY.register(data.get(1180));
        WITHER_SPAWN_EGG = REGISTRY.register(data.get(1181));
        WITHER_SKELETON_SPAWN_EGG = REGISTRY.register(data.get(1182));
        ZOMBIE_SPAWN_EGG = REGISTRY.register(data.get(1183));
        ZOMBIE_HORSE_SPAWN_EGG = REGISTRY.register(data.get(1184));
        ZOMBIE_NAUTILUS_SPAWN_EGG = REGISTRY.register(data.get(1185));
        ZOMBIE_VILLAGER_SPAWN_EGG = REGISTRY.register(data.get(1186));
        CAVE_SPIDER_SPAWN_EGG = REGISTRY.register(data.get(1187));
        SPIDER_SPAWN_EGG = REGISTRY.register(data.get(1188));
        BREEZE_SPAWN_EGG = REGISTRY.register(data.get(1189));
        CREAKING_SPAWN_EGG = REGISTRY.register(data.get(1190));
        CREEPER_SPAWN_EGG = REGISTRY.register(data.get(1191));
        ELDER_GUARDIAN_SPAWN_EGG = REGISTRY.register(data.get(1192));
        GUARDIAN_SPAWN_EGG = REGISTRY.register(data.get(1193));
        PHANTOM_SPAWN_EGG = REGISTRY.register(data.get(1194));
        SILVERFISH_SPAWN_EGG = REGISTRY.register(data.get(1195));
        SLIME_SPAWN_EGG = REGISTRY.register(data.get(1196));
        WARDEN_SPAWN_EGG = REGISTRY.register(data.get(1197));
        WITCH_SPAWN_EGG = REGISTRY.register(data.get(1198));
        EVOKER_SPAWN_EGG = REGISTRY.register(data.get(1199));
        PILLAGER_SPAWN_EGG = REGISTRY.register(data.get(1200));
        RAVAGER_SPAWN_EGG = REGISTRY.register(data.get(1201));
        VINDICATOR_SPAWN_EGG = REGISTRY.register(data.get(1202));
        VEX_SPAWN_EGG = REGISTRY.register(data.get(1203));
        BLAZE_SPAWN_EGG = REGISTRY.register(data.get(1204));
        GHAST_SPAWN_EGG = REGISTRY.register(data.get(1205));
        HAPPY_GHAST_SPAWN_EGG = REGISTRY.register(data.get(1206));
        HOGLIN_SPAWN_EGG = REGISTRY.register(data.get(1207));
        MAGMA_CUBE_SPAWN_EGG = REGISTRY.register(data.get(1208));
        PIGLIN_SPAWN_EGG = REGISTRY.register(data.get(1209));
        PIGLIN_BRUTE_SPAWN_EGG = REGISTRY.register(data.get(1210));
        STRIDER_SPAWN_EGG = REGISTRY.register(data.get(1211));
        ZOGLIN_SPAWN_EGG = REGISTRY.register(data.get(1212));
        ZOMBIFIED_PIGLIN_SPAWN_EGG = REGISTRY.register(data.get(1213));
        ENDER_DRAGON_SPAWN_EGG = REGISTRY.register(data.get(1214));
        ENDERMAN_SPAWN_EGG = REGISTRY.register(data.get(1215));
        ENDERMITE_SPAWN_EGG = REGISTRY.register(data.get(1216));
        SHULKER_SPAWN_EGG = REGISTRY.register(data.get(1217));
        EXPERIENCE_BOTTLE = REGISTRY.register(data.get(1218));
        FIRE_CHARGE = REGISTRY.register(data.get(1219));
        WIND_CHARGE = REGISTRY.register(data.get(1220));
        WRITABLE_BOOK = REGISTRY.register(data.get(1221));
        WRITTEN_BOOK = REGISTRY.register(data.get(1222));
        BREEZE_ROD = REGISTRY.register(data.get(1223));
        MACE = REGISTRY.register(data.get(1224));
        ITEM_FRAME = REGISTRY.register(data.get(1225));
        GLOW_ITEM_FRAME = REGISTRY.register(data.get(1226));
        FLOWER_POT = REGISTRY.register(data.get(1227));
        CARROT = REGISTRY.register(data.get(1228));
        POTATO = REGISTRY.register(data.get(1229));
        BAKED_POTATO = REGISTRY.register(data.get(1230));
        POISONOUS_POTATO = REGISTRY.register(data.get(1231));
        MAP = REGISTRY.register(data.get(1232));
        GOLDEN_CARROT = REGISTRY.register(data.get(1233));
        SKELETON_SKULL = REGISTRY.register(data.get(1234));
        WITHER_SKELETON_SKULL = REGISTRY.register(data.get(1235));
        PLAYER_HEAD = REGISTRY.register(data.get(1236));
        ZOMBIE_HEAD = REGISTRY.register(data.get(1237));
        CREEPER_HEAD = REGISTRY.register(data.get(1238));
        DRAGON_HEAD = REGISTRY.register(data.get(1239));
        PIGLIN_HEAD = REGISTRY.register(data.get(1240));
        NETHER_STAR = REGISTRY.register(data.get(1241));
        PUMPKIN_PIE = REGISTRY.register(data.get(1242));
        FIREWORK_ROCKET = REGISTRY.register(data.get(1243));
        FIREWORK_STAR = REGISTRY.register(data.get(1244));
        ENCHANTED_BOOK = REGISTRY.register(data.get(1245));
        NETHER_BRICK = REGISTRY.register(data.get(1246));
        RESIN_BRICK = REGISTRY.register(data.get(1247));
        PRISMARINE_SHARD = REGISTRY.register(data.get(1248));
        PRISMARINE_CRYSTALS = REGISTRY.register(data.get(1249));
        RABBIT = REGISTRY.register(data.get(1250));
        COOKED_RABBIT = REGISTRY.register(data.get(1251));
        RABBIT_STEW = REGISTRY.register(data.get(1252));
        RABBIT_FOOT = REGISTRY.register(data.get(1253));
        RABBIT_HIDE = REGISTRY.register(data.get(1254));
        ARMOR_STAND = REGISTRY.register(data.get(1255));
        COPPER_HORSE_ARMOR = REGISTRY.register(data.get(1256));
        IRON_HORSE_ARMOR = REGISTRY.register(data.get(1257));
        GOLDEN_HORSE_ARMOR = REGISTRY.register(data.get(1258));
        DIAMOND_HORSE_ARMOR = REGISTRY.register(data.get(1259));
        NETHERITE_HORSE_ARMOR = REGISTRY.register(data.get(1260));
        LEATHER_HORSE_ARMOR = REGISTRY.register(data.get(1261));
        LEAD = REGISTRY.register(data.get(1262));
        NAME_TAG = REGISTRY.register(data.get(1263));
        COMMAND_BLOCK_MINECART = REGISTRY.register(data.get(1264));
        MUTTON = REGISTRY.register(data.get(1265));
        COOKED_MUTTON = REGISTRY.register(data.get(1266));
        WHITE_BANNER = REGISTRY.register(data.get(1267));
        ORANGE_BANNER = REGISTRY.register(data.get(1268));
        MAGENTA_BANNER = REGISTRY.register(data.get(1269));
        LIGHT_BLUE_BANNER = REGISTRY.register(data.get(1270));
        YELLOW_BANNER = REGISTRY.register(data.get(1271));
        LIME_BANNER = REGISTRY.register(data.get(1272));
        PINK_BANNER = REGISTRY.register(data.get(1273));
        GRAY_BANNER = REGISTRY.register(data.get(1274));
        LIGHT_GRAY_BANNER = REGISTRY.register(data.get(1275));
        CYAN_BANNER = REGISTRY.register(data.get(1276));
        PURPLE_BANNER = REGISTRY.register(data.get(1277));
        BLUE_BANNER = REGISTRY.register(data.get(1278));
        BROWN_BANNER = REGISTRY.register(data.get(1279));
        GREEN_BANNER = REGISTRY.register(data.get(1280));
        RED_BANNER = REGISTRY.register(data.get(1281));
        BLACK_BANNER = REGISTRY.register(data.get(1282));
        END_CRYSTAL = REGISTRY.register(data.get(1283));
        CHORUS_FRUIT = REGISTRY.register(data.get(1284));
        POPPED_CHORUS_FRUIT = REGISTRY.register(data.get(1285));
        TORCHFLOWER_SEEDS = REGISTRY.register(data.get(1286));
        PITCHER_POD = REGISTRY.register(data.get(1287));
        BEETROOT = REGISTRY.register(data.get(1288));
        BEETROOT_SEEDS = REGISTRY.register(data.get(1289));
        BEETROOT_SOUP = REGISTRY.register(data.get(1290));
        DRAGON_BREATH = REGISTRY.register(data.get(1291));
        SPLASH_POTION = REGISTRY.register(data.get(1292));
        SPECTRAL_ARROW = REGISTRY.register(data.get(1293));
        TIPPED_ARROW = REGISTRY.register(data.get(1294));
        LINGERING_POTION = REGISTRY.register(data.get(1295));
        SHIELD = REGISTRY.register(data.get(1296));
        WOODEN_SPEAR = REGISTRY.register(data.get(1297));
        STONE_SPEAR = REGISTRY.register(data.get(1298));
        COPPER_SPEAR = REGISTRY.register(data.get(1299));
        IRON_SPEAR = REGISTRY.register(data.get(1300));
        GOLDEN_SPEAR = REGISTRY.register(data.get(1301));
        DIAMOND_SPEAR = REGISTRY.register(data.get(1302));
        NETHERITE_SPEAR = REGISTRY.register(data.get(1303));
        TOTEM_OF_UNDYING = REGISTRY.register(data.get(1304));
        SHULKER_SHELL = REGISTRY.register(data.get(1305));
        IRON_NUGGET = REGISTRY.register(data.get(1306));
        COPPER_NUGGET = REGISTRY.register(data.get(1307));
        KNOWLEDGE_BOOK = REGISTRY.register(data.get(1308));
        DEBUG_STICK = REGISTRY.register(data.get(1309));
        MUSIC_DISC_13 = REGISTRY.register(data.get(1310));
        MUSIC_DISC_CAT = REGISTRY.register(data.get(1311));
        MUSIC_DISC_BLOCKS = REGISTRY.register(data.get(1312));
        MUSIC_DISC_CHIRP = REGISTRY.register(data.get(1313));
        MUSIC_DISC_CREATOR = REGISTRY.register(data.get(1314));
        MUSIC_DISC_CREATOR_MUSIC_BOX = REGISTRY.register(data.get(1315));
        MUSIC_DISC_FAR = REGISTRY.register(data.get(1316));
        MUSIC_DISC_LAVA_CHICKEN = REGISTRY.register(data.get(1317));
        MUSIC_DISC_MALL = REGISTRY.register(data.get(1318));
        MUSIC_DISC_MELLOHI = REGISTRY.register(data.get(1319));
        MUSIC_DISC_STAL = REGISTRY.register(data.get(1320));
        MUSIC_DISC_STRAD = REGISTRY.register(data.get(1321));
        MUSIC_DISC_WARD = REGISTRY.register(data.get(1322));
        MUSIC_DISC_11 = REGISTRY.register(data.get(1323));
        MUSIC_DISC_WAIT = REGISTRY.register(data.get(1324));
        MUSIC_DISC_OTHERSIDE = REGISTRY.register(data.get(1325));
        MUSIC_DISC_RELIC = REGISTRY.register(data.get(1326));
        MUSIC_DISC_5 = REGISTRY.register(data.get(1327));
        MUSIC_DISC_PIGSTEP = REGISTRY.register(data.get(1328));
        MUSIC_DISC_PRECIPICE = REGISTRY.register(data.get(1329));
        MUSIC_DISC_TEARS = REGISTRY.register(data.get(1330));
        DISC_FRAGMENT_5 = REGISTRY.register(data.get(1331));
        TRIDENT = REGISTRY.register(data.get(1332));
        NAUTILUS_SHELL = REGISTRY.register(data.get(1333));
        IRON_NAUTILUS_ARMOR = REGISTRY.register(data.get(1334));
        GOLDEN_NAUTILUS_ARMOR = REGISTRY.register(data.get(1335));
        DIAMOND_NAUTILUS_ARMOR = REGISTRY.register(data.get(1336));
        NETHERITE_NAUTILUS_ARMOR = REGISTRY.register(data.get(1337));
        COPPER_NAUTILUS_ARMOR = REGISTRY.register(data.get(1338));
        HEART_OF_THE_SEA = REGISTRY.register(data.get(1339));
        CROSSBOW = REGISTRY.register(data.get(1340));
        SUSPICIOUS_STEW = REGISTRY.register(data.get(1341));
        LOOM = REGISTRY.register(data.get(1342));
        FLOWER_BANNER_PATTERN = REGISTRY.register(data.get(1343));
        CREEPER_BANNER_PATTERN = REGISTRY.register(data.get(1344));
        SKULL_BANNER_PATTERN = REGISTRY.register(data.get(1345));
        MOJANG_BANNER_PATTERN = REGISTRY.register(data.get(1346));
        GLOBE_BANNER_PATTERN = REGISTRY.register(data.get(1347));
        PIGLIN_BANNER_PATTERN = REGISTRY.register(data.get(1348));
        FLOW_BANNER_PATTERN = REGISTRY.register(data.get(1349));
        GUSTER_BANNER_PATTERN = REGISTRY.register(data.get(1350));
        FIELD_MASONED_BANNER_PATTERN = REGISTRY.register(data.get(1351));
        BORDURE_INDENTED_BANNER_PATTERN = REGISTRY.register(data.get(1352));
        GOAT_HORN = REGISTRY.register(data.get(1353));
        COMPOSTER = REGISTRY.register(data.get(1354));
        BARREL = REGISTRY.register(data.get(1355));
        SMOKER = REGISTRY.register(data.get(1356));
        BLAST_FURNACE = REGISTRY.register(data.get(1357));
        CARTOGRAPHY_TABLE = REGISTRY.register(data.get(1358));
        FLETCHING_TABLE = REGISTRY.register(data.get(1359));
        GRINDSTONE = REGISTRY.register(data.get(1360));
        SMITHING_TABLE = REGISTRY.register(data.get(1361));
        STONECUTTER = REGISTRY.register(data.get(1362));
        BELL = REGISTRY.register(data.get(1363));
        LANTERN = REGISTRY.register(data.get(1364));
        SOUL_LANTERN = REGISTRY.register(data.get(1365));
        COPPER_LANTERN = REGISTRY.register(data.get(1366));
        EXPOSED_COPPER_LANTERN = REGISTRY.register(data.get(1367));
        WEATHERED_COPPER_LANTERN = REGISTRY.register(data.get(1368));
        OXIDIZED_COPPER_LANTERN = REGISTRY.register(data.get(1369));
        WAXED_COPPER_LANTERN = REGISTRY.register(data.get(1370));
        WAXED_EXPOSED_COPPER_LANTERN = REGISTRY.register(data.get(1371));
        WAXED_WEATHERED_COPPER_LANTERN = REGISTRY.register(data.get(1372));
        WAXED_OXIDIZED_COPPER_LANTERN = REGISTRY.register(data.get(1373));
        SWEET_BERRIES = REGISTRY.register(data.get(1374));
        GLOW_BERRIES = REGISTRY.register(data.get(1375));
        CAMPFIRE = REGISTRY.register(data.get(1376));
        SOUL_CAMPFIRE = REGISTRY.register(data.get(1377));
        SHROOMLIGHT = REGISTRY.register(data.get(1378));
        HONEYCOMB = REGISTRY.register(data.get(1379));
        BEE_NEST = REGISTRY.register(data.get(1380));
        BEEHIVE = REGISTRY.register(data.get(1381));
        HONEY_BOTTLE = REGISTRY.register(data.get(1382));
        HONEYCOMB_BLOCK = REGISTRY.register(data.get(1383));
        LODESTONE = REGISTRY.register(data.get(1384));
        CRYING_OBSIDIAN = REGISTRY.register(data.get(1385));
        BLACKSTONE = REGISTRY.register(data.get(1386));
        BLACKSTONE_SLAB = REGISTRY.register(data.get(1387));
        BLACKSTONE_STAIRS = REGISTRY.register(data.get(1388));
        GILDED_BLACKSTONE = REGISTRY.register(data.get(1389));
        POLISHED_BLACKSTONE = REGISTRY.register(data.get(1390));
        POLISHED_BLACKSTONE_SLAB = REGISTRY.register(data.get(1391));
        POLISHED_BLACKSTONE_STAIRS = REGISTRY.register(data.get(1392));
        CHISELED_POLISHED_BLACKSTONE = REGISTRY.register(data.get(1393));
        POLISHED_BLACKSTONE_BRICKS = REGISTRY.register(data.get(1394));
        POLISHED_BLACKSTONE_BRICK_SLAB = REGISTRY.register(data.get(1395));
        POLISHED_BLACKSTONE_BRICK_STAIRS = REGISTRY.register(data.get(1396));
        CRACKED_POLISHED_BLACKSTONE_BRICKS = REGISTRY.register(data.get(1397));
        RESPAWN_ANCHOR = REGISTRY.register(data.get(1398));
        CANDLE = REGISTRY.register(data.get(1399));
        WHITE_CANDLE = REGISTRY.register(data.get(1400));
        ORANGE_CANDLE = REGISTRY.register(data.get(1401));
        MAGENTA_CANDLE = REGISTRY.register(data.get(1402));
        LIGHT_BLUE_CANDLE = REGISTRY.register(data.get(1403));
        YELLOW_CANDLE = REGISTRY.register(data.get(1404));
        LIME_CANDLE = REGISTRY.register(data.get(1405));
        PINK_CANDLE = REGISTRY.register(data.get(1406));
        GRAY_CANDLE = REGISTRY.register(data.get(1407));
        LIGHT_GRAY_CANDLE = REGISTRY.register(data.get(1408));
        CYAN_CANDLE = REGISTRY.register(data.get(1409));
        PURPLE_CANDLE = REGISTRY.register(data.get(1410));
        BLUE_CANDLE = REGISTRY.register(data.get(1411));
        BROWN_CANDLE = REGISTRY.register(data.get(1412));
        GREEN_CANDLE = REGISTRY.register(data.get(1413));
        RED_CANDLE = REGISTRY.register(data.get(1414));
        BLACK_CANDLE = REGISTRY.register(data.get(1415));
        SMALL_AMETHYST_BUD = REGISTRY.register(data.get(1416));
        MEDIUM_AMETHYST_BUD = REGISTRY.register(data.get(1417));
        LARGE_AMETHYST_BUD = REGISTRY.register(data.get(1418));
        AMETHYST_CLUSTER = REGISTRY.register(data.get(1419));
        POINTED_DRIPSTONE = REGISTRY.register(data.get(1420));
        OCHRE_FROGLIGHT = REGISTRY.register(data.get(1421));
        VERDANT_FROGLIGHT = REGISTRY.register(data.get(1422));
        PEARLESCENT_FROGLIGHT = REGISTRY.register(data.get(1423));
        FROGSPAWN = REGISTRY.register(data.get(1424));
        ECHO_SHARD = REGISTRY.register(data.get(1425));
        BRUSH = REGISTRY.register(data.get(1426));
        NETHERITE_UPGRADE_SMITHING_TEMPLATE = REGISTRY.register(data.get(1427));
        SENTRY_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1428));
        DUNE_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1429));
        COAST_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1430));
        WILD_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1431));
        WARD_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1432));
        EYE_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1433));
        VEX_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1434));
        TIDE_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1435));
        SNOUT_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1436));
        RIB_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1437));
        SPIRE_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1438));
        WAYFINDER_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1439));
        SHAPER_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1440));
        SILENCE_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1441));
        RAISER_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1442));
        HOST_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1443));
        FLOW_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1444));
        BOLT_ARMOR_TRIM_SMITHING_TEMPLATE = REGISTRY.register(data.get(1445));
        ANGLER_POTTERY_SHERD = REGISTRY.register(data.get(1446));
        ARCHER_POTTERY_SHERD = REGISTRY.register(data.get(1447));
        ARMS_UP_POTTERY_SHERD = REGISTRY.register(data.get(1448));
        BLADE_POTTERY_SHERD = REGISTRY.register(data.get(1449));
        BREWER_POTTERY_SHERD = REGISTRY.register(data.get(1450));
        BURN_POTTERY_SHERD = REGISTRY.register(data.get(1451));
        DANGER_POTTERY_SHERD = REGISTRY.register(data.get(1452));
        EXPLORER_POTTERY_SHERD = REGISTRY.register(data.get(1453));
        FLOW_POTTERY_SHERD = REGISTRY.register(data.get(1454));
        FRIEND_POTTERY_SHERD = REGISTRY.register(data.get(1455));
        GUSTER_POTTERY_SHERD = REGISTRY.register(data.get(1456));
        HEART_POTTERY_SHERD = REGISTRY.register(data.get(1457));
        HEARTBREAK_POTTERY_SHERD = REGISTRY.register(data.get(1458));
        HOWL_POTTERY_SHERD = REGISTRY.register(data.get(1459));
        MINER_POTTERY_SHERD = REGISTRY.register(data.get(1460));
        MOURNER_POTTERY_SHERD = REGISTRY.register(data.get(1461));
        PLENTY_POTTERY_SHERD = REGISTRY.register(data.get(1462));
        PRIZE_POTTERY_SHERD = REGISTRY.register(data.get(1463));
        SCRAPE_POTTERY_SHERD = REGISTRY.register(data.get(1464));
        SHEAF_POTTERY_SHERD = REGISTRY.register(data.get(1465));
        SHELTER_POTTERY_SHERD = REGISTRY.register(data.get(1466));
        SKULL_POTTERY_SHERD = REGISTRY.register(data.get(1467));
        SNORT_POTTERY_SHERD = REGISTRY.register(data.get(1468));
        COPPER_GRATE = REGISTRY.register(data.get(1469));
        EXPOSED_COPPER_GRATE = REGISTRY.register(data.get(1470));
        WEATHERED_COPPER_GRATE = REGISTRY.register(data.get(1471));
        OXIDIZED_COPPER_GRATE = REGISTRY.register(data.get(1472));
        WAXED_COPPER_GRATE = REGISTRY.register(data.get(1473));
        WAXED_EXPOSED_COPPER_GRATE = REGISTRY.register(data.get(1474));
        WAXED_WEATHERED_COPPER_GRATE = REGISTRY.register(data.get(1475));
        WAXED_OXIDIZED_COPPER_GRATE = REGISTRY.register(data.get(1476));
        COPPER_BULB = REGISTRY.register(data.get(1477));
        EXPOSED_COPPER_BULB = REGISTRY.register(data.get(1478));
        WEATHERED_COPPER_BULB = REGISTRY.register(data.get(1479));
        OXIDIZED_COPPER_BULB = REGISTRY.register(data.get(1480));
        WAXED_COPPER_BULB = REGISTRY.register(data.get(1481));
        WAXED_EXPOSED_COPPER_BULB = REGISTRY.register(data.get(1482));
        WAXED_WEATHERED_COPPER_BULB = REGISTRY.register(data.get(1483));
        WAXED_OXIDIZED_COPPER_BULB = REGISTRY.register(data.get(1484));
        COPPER_CHEST = REGISTRY.register(data.get(1485));
        EXPOSED_COPPER_CHEST = REGISTRY.register(data.get(1486));
        WEATHERED_COPPER_CHEST = REGISTRY.register(data.get(1487));
        OXIDIZED_COPPER_CHEST = REGISTRY.register(data.get(1488));
        WAXED_COPPER_CHEST = REGISTRY.register(data.get(1489));
        WAXED_EXPOSED_COPPER_CHEST = REGISTRY.register(data.get(1490));
        WAXED_WEATHERED_COPPER_CHEST = REGISTRY.register(data.get(1491));
        WAXED_OXIDIZED_COPPER_CHEST = REGISTRY.register(data.get(1492));
        COPPER_GOLEM_STATUE = REGISTRY.register(data.get(1493));
        EXPOSED_COPPER_GOLEM_STATUE = REGISTRY.register(data.get(1494));
        WEATHERED_COPPER_GOLEM_STATUE = REGISTRY.register(data.get(1495));
        OXIDIZED_COPPER_GOLEM_STATUE = REGISTRY.register(data.get(1496));
        WAXED_COPPER_GOLEM_STATUE = REGISTRY.register(data.get(1497));
        WAXED_EXPOSED_COPPER_GOLEM_STATUE = REGISTRY.register(data.get(1498));
        WAXED_WEATHERED_COPPER_GOLEM_STATUE = REGISTRY.register(data.get(1499));
        WAXED_OXIDIZED_COPPER_GOLEM_STATUE = REGISTRY.register(data.get(1500));
        TRIAL_SPAWNER = REGISTRY.register(data.get(1501));
        TRIAL_KEY = REGISTRY.register(data.get(1502));
        OMINOUS_TRIAL_KEY = REGISTRY.register(data.get(1503));
        VAULT = REGISTRY.register(data.get(1504));
        OMINOUS_BOTTLE = REGISTRY.register(data.get(1505));
    }
}
