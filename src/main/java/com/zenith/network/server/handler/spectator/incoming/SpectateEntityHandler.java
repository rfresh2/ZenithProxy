...
public class SpectateEntityHandler implements PacketHandler<ServerboundSpectateEntityPacket, ServerSession> {
    @Override
    public ServerboundSpectateEntityPacket apply(final ServerboundSpectateEntityPacket packet, final ServerSession session) {
