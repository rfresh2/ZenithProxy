...
public class DeathsRecord extends TableRecordImpl<DeathsRecord> implements Record7<OffsetDateTime, String, String, UUID, String, UUID, String> {
     ...
     */
    public DeathsRecord(OffsetDateTime time, String deathMessage, String victimPlayerName, UUID victimPlayerUuid, String killerPlayerName, UUID killerPlayerUuid, String weaponName) {
        super(Deaths.DEATHS);
    ...
    @Override
    public Row7<OffsetDateTime, String, String, UUID, String, UUID, String> valuesRow() {
    ...
    @Override
    public DeathsRecord values(OffsetDateTime value1, String value2, String value3, UUID value4, String value5, UUID value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
