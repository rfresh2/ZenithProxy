...
public class BlockDataManager {
    ...
    private void init() {
        ...
        try (JsonParser blocksParser = OBJECT_MAPPER.createParser(getClass().getResourceAsStream("/pc/1.20.4/blocks.json"))) {
        ...
        try (JsonParser shapesParser = OBJECT_MAPPER.createParser(getClass().getResourceAsStream("/pc/1.20.4/blockCollisionShapes.json"))) {
