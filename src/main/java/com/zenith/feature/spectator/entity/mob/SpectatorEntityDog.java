...
//                new EntityMetadata(14, MetadataType.OPTIONAL_UUID, this.getProfileCache().getProfile().getId()), // mob owner
                new FloatEntityMetadata(15, MetadataType.FLOAT, 1.0f), // damage taken/tail rotation (?)
                new BooleanEntityMetadata(16, MetadataType.BOOLEAN, false), // begging, i think this tilts the head
                new IntEntityMetadata(17, MetadataType.INT, (spectatorEntityId % 16)) // collar color
        };
    }
