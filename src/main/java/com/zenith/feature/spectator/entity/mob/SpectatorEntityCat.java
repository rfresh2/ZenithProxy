...
public class SpectatorEntityCat extends SpectatorMob {
    ...
    private EntityMetadata[] getEntityMetadata(final GameProfile spectatorProfile, final int spectatorEntityId, final boolean self) {
        return new EntityMetadata[]{
                ...
                new BooleanEntityMetadata(12, MetadataType.BOOLEAN, false),
                new ByteEntityMetadata(13, MetadataType.BYTE, (byte) 4),
//                new EntityMetadata(14, MetadataType.OPTIONAL_UUID, this.getProfileCache().getProfile().getId()), // mob owner
                new IntEntityMetadata(15, MetadataType.INT, (spectatorEntityId % 3) + 1) // cat texture variant
        };
    }
