...
public class SpectatorEntityPlayerHead extends SpectatorMob {
    ...
    private int playerHeadItemId = Shared.ITEMS_MANAGER.getItemId("player_head");
    ...
    private EntityMetadata[] getEntityMetadata(final GameProfile spectatorProfile, final int spectatorEntityId, final boolean self) {
        ...
        var mnbt = MNBTIO.write(tag, true);
        return new EntityMetadata[]{
            ...
            new ObjectEntityMetadata<>(22, MetadataType.ITEM, new ItemStack(playerHeadItemId, 1, mnbt))
        };
    }
