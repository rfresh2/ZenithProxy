...
public final class BlockRegistry {
    public static final Registry<Block> REGISTRY = new Registry<>(1058);
    ...
    public static final Block TRIAL_SPAWNER = register(new Block(1057, "trial_spawner", true, 26638, 26643, 11, BlockEntityType.TRIAL_SPAWNER));
