...
public class ALMovePlayerPosRotHandler implements IncomingHandler<ServerboundMovePlayerPosRotPacket, ServerConnection> {
    @Override
    public boolean apply(final ServerboundMovePlayerPosRotPacket packet, final ServerConnection session) {
