./build/java_toolchain --enable-preview -server -XX:MaxRAMPercentage=30 -XX:MinRAMPercentage=30 \
...
-Djava.util.concurrent.ForkJoinPool.common.parallelism=16 -Dio.netty.allocator.maxOrder=9 -Dio.netty.eventLoopThreads=2 \
