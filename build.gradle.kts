...
dependencies {
    ...
    shade("com.github.rfresh2:MCProtocolLib:3f15beff90") {
    ...
    shade("com.viaversion:viaversion:5.0.0-20240517.190711-8")
    shade("com.viaversion:viabackwards:5.0.0-20240515.152913-2")
