...
dependencies {
    ...
    shade("com.github.rfresh2:MCProtocolLib:27bcd4bfa4") {
    ...
    shade("com.viaversion:viaversion:5.0.0-20240613.172210-50")
    shade("com.viaversion:viabackwards:5.0.0-20240613.164410-26")
