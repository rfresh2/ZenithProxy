...
(function(Y) {
    function C(b, a, c) {
        ...
        if ("SHA-1" === b) m = 512, q = K, u = Z, f = 160, r = function(a) {
            ...
            if (q = function(a, c) {
                    ...
                    if ("SHA-224" === b) a = [e[0], e[1], e[2], e[3], e[4], e[5], e[6]];
                    else if ("SHA-256" === b) a = e;
                    else if ("SHA-384" === b) a = [e[0].a, e[0].b, e[1].a, e[1].b, e[2].a, e[2].b, e[3].a, e[3].b, e[4].a, e[4].b, e[5].a, e[5].b];
                    else if ("SHA-512" === b) a = [e[0].a, e[0].b, e[1].a, e[1].b, e[2].a, e[2].b, e[3].a, e[3].b, e[4].a,
            ...
            u = function(a, b, e, c, h) {
                ...
                var k = F,
                    ...
                    l = 0,
                    d = b >>> 5;
                for (f = 0; f < d && b >= e; f += n) c = D(a.slice(f, f + n), c), b -= e;
                a = a.slice(f);
        ...
        this.setHMACKey = function(a, c, h) {
            ...
            for (a = 0; a <= h; a += 1) v[a] = c[a] ^ 909522486, w[a] = c[a] ^ 1549556828;
            l = q(v, l);
            e = m;
            I = !0
        };
        this.update = function(a) {
            ...
            c = b.value;
            b = a >>> 5;
            for (k = 0; k < b; k += g) f + m <= a && (l = q(c.slice(k, k + g), l), f += m);
            e += f;
            h = c.slice(f >>> 5);
            n = a % m;
            y = !0
    ...
    function O(b, a, c, e) {
        ...
        var n, g, d;
        d = -1 === c ? 3 : 0;
        for (n = 0; n < a; n += 1) g = b[n >>> 2] >>> 8 * (d + n % 4 * c), h += "0123456789abcdef".charAt(g >>> 4 & 15) + "0123456789abcdef".charAt(g & 15);
    ...
    function P(b, a, c, e) {
        ...
        f = -1 === c ? 3 : 0;
        for (g = 0; g < n; g += 3)
            for (d = g + 1 < n ? b[g + 1 >>> 2] : 0, p = g + 2 < n ? b[g + 2 >>> 2] : 0, p = (b[g >>> 2] >>> 8 * (f + g % 4 * c) & 255) << 16 | (d >>> 8 * (f + (g + 1) % 4 * c) & 255) << 8 | p >>> 8 * (f +
                    (g + 2) % 4 * c) & 255, d = 0; 4 > d; d += 1) 8 * g + 6 * d <= a ? h += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p >>> 6 * (3 - d) & 63) : h += e.b64Pad;
        return h
    }
    ...
    function Q(b, a, c) {
        ...
        var h, d, g;
        g = -1 === c ? 3 : 0;
        for (h = 0; h < a; h += 1) d = b[h >>> 2] >>> 8 * (g + h % 4 * c) & 255, e += String.fromCharCode(d);
        return e
    }
    ...
    function R(b, a, c) {
        ...
        var e, h = new ArrayBuffer(a),
            d;
        d = -1 === c ? 3 : 0;
        for (e = 0; e < a; e += 1) h[e] = b[e >>> 2] >>> 8 * (d + e % 4 * c) & 255;
        return h
    }
        ...
        switch (b) {
                ...
                b = function(b, h, d) {
                    ...
                    if ("UTF8" === a)
                        for (t = -1 ===
                            ...
                            for (g = b.charCodeAt(f), l = [], 128 > g ? l.push(g) : 2048 > g ? (l.push(192 | g >>> 6), l.push(128 | g & 63)) : 55296 > g || 57344 <= g ? l.push(224 | g >>> 12, 128 | g >>> 6 & 63, 128 | g & 63) : (f += 1, g = 65536 + ((g & 1023) << 10 | b.charCodeAt(f) & 1023), l.push(240 | g >>> 18, 128 | g >>> 12 & 63, 128 | g >>> 6 & 63, 128 | g & 63)), m = 0; m < l.length; m += 1) {
                                r = p + q;
            ...
            case "BYTES":
                b = function(a, b, d) {
                    ...
                    p = d >>> 3;
                    q = -1 === c ? 3 : 0;
                    for (l = 0; l < a.length; l += 1) g = a.charCodeAt(l), m = l + p, f = m >>> 2, b.length <= f && b.push(0), b[f] |= g << 8 * (q + m % 4 * c);
                    return {
                        value: b,
                        binLen: 8 * a.length + d
                    }
            ...
            case "ARRAYBUFFER":
                ...
                b =
                    function(a, b, d) {
                        ...
                        l = d >>> 3;
                        m = -1 === c ? 3 : 0;
                        for (g = 0; g < a.byteLength; g += 1) f = g + l, p = f >>> 2, b.length <= p && b.push(0), b[p] |= a[g] << 8 * (m + f % 4 * c);
                        return {
                            value: b,
    ...
    function la(b, a, c, e) {
        ...
        return ((b >>> 16) + (a >>> 16) + (c >>> 16) + (e >>> 16) + (h >>> 16) & 65535) << 16 | h & 65535
    }

    function H(b, a, c, e, h) {
        var d = (b & 65535) + (a & 65535) + (c & 65535) + (e & 65535) + (h & 65535);
        return ((b >>> 16) + (a >>> 16) + (c >>> 16) + (e >>> 16) + (h >>> 16) + (d >>> 16) & 65535) << 16 | d & 65535
    }
    ...
    function na(b, a, d, e) {
        ...
        n = (b.b >>> 16) + (a.b >>> 16) + (d.b >>> 16) + (e.b >>> 16) + (h >>> 16);
        g = (n & 65535) << 16 | h & 65535;
        h = (b.a & 65535) + (a.a & 65535) + (d.a & 65535) + (e.a & 65535) + (n >>> 16);
        n = (b.a >>> 16) + (a.a >>> 16) + (d.a >>> 16) + (e.a >>> 16) + (h >>> 16);
        return new c((n & 65535) << 16 | h & 65535, g)
    }

    function oa(b, a, d, e, h) {
        var n, g, l;
        n = (b.b & 65535) + (a.b & 65535) + (d.b &
            65535) + (e.b & 65535) + (h.b & 65535);
        g = (b.b >>> 16) + (a.b >>> 16) + (d.b >>> 16) + (e.b >>> 16) + (h.b >>> 16) + (n >>> 16);
        l = (g & 65535) << 16 | n & 65535;
        n = (b.a & 65535) + (a.a & 65535) + (d.a & 65535) + (e.a & 65535) + (h.a & 65535) + (g >>> 16);
        g = (b.a >>> 16) + (a.a >>> 16) + (d.a >>> 16) + (e.a >>> 16) + (h.a >>> 16) + (n >>> 16);
    ...
    function A(b) {
        ...
        if ("SHA-1" === b) a = [1732584193, 4023233417, 2562383102, 271733878, 3285377520];
        else if (0 === b.lastIndexOf("SHA-", 0)) switch (a = [3238371032, 914150663,
                812702999, 4144912697, 4290775857, 1750603025, 1694076839, 3204075428
            ], d = [1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225], b) {
                case "SHA-224":
                    break;
                case "SHA-256":
                    a = d;
                ...
                case "SHA-384":
                    ...
                    break;
                case "SHA-512":
                    a = [new c(d[0], 4089235720), new c(d[1], 2227873595), new c(d[2], 4271175723),
                        new c(d[3], 1595750129), new c(d[4], 2917565137), new c(d[5], 725511199), new c(d[6], 4215389547), new c(d[7], 327033209)
                    ];
                    break;
                default:
    ...
    function K(b, a) {
        ...
        g = a[3];
        l = a[4];
        for (f = 0; 80 > f; f += 1) c[f] = 16 > f ? b[f] : y(c[f - 3] ^ c[f - 8] ^ c[f - 14] ^ c[f - 16],
            1), p = 20 > f ? H(y(e, 5), d & n ^ ~d & g, l, 1518500249, c[f]) : 40 > f ? H(y(e, 5), d ^ n ^ g, l, 1859775393, c[f]) : 60 > f ? H(y(e, 5), U(d, n, g), l, 2400959708, c[f]) : H(y(e, 5), d ^ n ^ g, l, 3395469782, c[f]), l = g, g = n, n = y(d, 30), d = e, e = p;
        a[0] = G(e, a[0]);
        a[1] = G(d, a[1]);
        a[2] = G(n, a[2]);
        a[3] = G(g, a[3]);
    ...
    function L(b, a, k) {
        var e, h, n,
            g, l, p, f, m, q, u, r, t, v, w, y, A, z, x, F, B, C, D, E = [],
            J;
        if ("SHA-224" === k || "SHA-256" === k) u = 64, t = 1, D = Number, v = G, w = la, y = H, A = ha, z = ja, x = da, F = fa, C = U, B = aa, J = d;
        else if ("SHA-384" === k || "SHA-512" === k) u = 80, t = 2, D = c, v = ma, w = na, y = oa, A = ia, z = ka, x = ea, F = ga, C = ca, B = ba, J = V;
        else throw Error("Unexpected error in SHA-2 implementation");
        k = a[0];
        e = a[1];
        h = a[2];
        ...
        p = a[6];
        f = a[7];
        for (r = 0; r < u; r += 1) 16 > r ? (q = r * t, m = b.length <= q ? 0 : b[q], q = b.length <= q + 1 ? 0 : b[q + 1], E[r] = new D(m, q)) : E[r] = w(z(E[r - 2]), E[r - 7], A(E[r - 15]), E[r - 16]), m = y(f, F(g),
            B(g, l, p), J[r], E[r]), q = v(x(k), C(k, e, h)), f = p, p = l, l = g, g = v(n, m), n = h, h = e, e = k, k = v(m, q);
        a[0] = v(k, a[0]);
        a[1] = v(e, a[1]);
        a[2] = v(h, a[2]);
        a[3] = v(n, a[3]);
    ...
    function D(b, a) {
        var d, e, h, n, g = [],
            l = [];
        if (null !== b)
            for (e = 0; e < b.length; e += 2) a[(e >>> 1) % 5][(e >>> 1) / 5 | 0] = B(a[(e >>> 1) % 5][(e >>> 1) / 5 | 0], new c(b[e + 1], b[e]));
        for (d = 0; 24 > d; d += 1) {
            n = A("SHA3-");
            for (e = 0; 5 > e; e += 1) {
                h = a[e][0];
                var p = a[e][1],
                    ...
                    m = a[e][3],
                    q = a[e][4];
                g[e] = new c(h.a ^ p.a ^ f.a ^ m.a ^ q.a, h.b ^ p.b ^
                    f.b ^ m.b ^ q.b)
            }
            ...
            for (e = 0; 5 > e; e += 1)
                for (h = 0; 5 > h; h += 1) a[e][h] = B(n[e][h], new c(~n[(e + 1) % 5][h].a & n[(e + 2) % 5][h].a, ~n[(e + 1) % 5][h].b & n[(e + 2) % 5][h].b));
            a[0][0] = B(a[0][0], X[d])
        }
        return a
    }
    var d, V, W, X;
    d = [1116352408, 1899447441, 3049323471, 3921009573, 961987163, 1508970993, 2453635748, 2870763221, 3624381080, 310598401, 607225278, 1426881987, 1925078388,
