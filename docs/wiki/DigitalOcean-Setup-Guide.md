...
![Create Droplet](./_assets/img/DigitalOcean-Setup-Guide-1.png)

## Select OS and Specs
Select New York (any datacenter) for lowest ping to 2b2t and best connection reliability
![Select OS and Specs](./_assets/img/DigitalOcean-Setup-Guide-2.png)

![OS and Plan Settings](./_assets/img/DigitalOcean-Setup-Guide-3.png)

## Setup Authentication

Set a password, or an SSH key if you are familiar with them

![Authentication](./_assets/img/DigitalOcean-Setup-Guide-4.png)

## Click Advanced Options
![Click Advanced Options](./_assets/img/DigitalOcean-Setup-Guide-5.png)

## Click Add Initialization Scripts
![Click Add Initialization Scripts](./_assets/img/DigitalOcean-Setup-Guide-6.png)

## Copy Paste the Setup script

Script link: https://github.com/rfresh2/ZenithProxy/blob/1.21.4/scripts/cloud-init.yaml

![Copy Paste the Setup script](./_assets/img/DigitalOcean-Setup-Guide-7.png)
...
## Create Droplet
![Create Droplet](./_assets/img/DigitalOcean-Setup-Guide-8.png)
...
![Droplet IP](./_assets/img/DigitalOcean-Setup-Guide-9.png)
...
![SSH example](./_assets/img/DigitalOcean-Setup-Guide-10.png)
...
![TMUX](./_assets/img/DigitalOcean-Setup-Guide-11.png)
...
![ZenithProxy Setup](./_assets/img/DigitalOcean-Setup-Guide-12.png)
