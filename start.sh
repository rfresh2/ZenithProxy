...
do
  "$BUILD_SCRIPT"
	...
	java -server -Xmx180M -XX:NewSize=80M -D java.util.concurrent.ForkJoinPool.common.parallelism=16 -XX:+UseSerialGC -jar -Djava.util.concurrent.ForkJoinPool.common.parallelism=16 build/libs/Proxy.jar
